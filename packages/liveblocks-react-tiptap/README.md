...
<p>
  ...
  <a href="https://github.com/liveblocks/liveblocks/blob/main/licenses/LICENSE-APACHE-2.0"><img src="https://img.shields.io/badge/licenses-Apache--2.0-green" alt="License" /></a>
</p>

`@liveblocks/react-tiptap` provides [React](https://reactjs.org/) APIs to
integrate [Tiptap](https://tiptap.dev/) text editors with Liveblocks—a platform
...
Read the
[documentation](https://liveblocks.io/docs/api-reference/liveblocks-react-tiptap)
