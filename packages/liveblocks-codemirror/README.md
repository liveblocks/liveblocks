...
<p>
  <a href="https://npmjs.org/package/@liveblocks/codemirror"><img src="https://img.shields.io/npm/v/@liveblocks/codemirror?style=flat&label=npm&color=c33" alt="NPM" /></a>
  <a href="https://bundlephobia.com/package/@liveblocks/codemirror"><img src="https://img.shields.io/bundlephobia/minzip/@liveblocks/codemirror?style=flat&label=size&color=09f" alt="Size" /></a>
...
`@liveblocks/codemirror` provides [CodeMirror](https://codemirror.net/) plugins
that sync a document with Liveblocks Storage and display remote carets and
selections.
...
Read the
[documentation](https://liveblocks.io/docs/api-reference/liveblocks-codemirror)
