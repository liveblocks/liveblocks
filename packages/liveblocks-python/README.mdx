...
<PropertiesList title="Parameters">
  ...
  <PropertiesListItem name="query" type="str | Unset">
    ...
    roomId^"liveblocks:engineering" AND hasComments:true`. The `hasComments`
    filter checks whether rooms contain at least one comment. Learn more about
    [filtering rooms with query
