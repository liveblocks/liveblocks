...
T = TypeVar("T", bound="UpdateManagementProject")


@_attrs_define
class UpdateManagementProject:
    """
    Attributes:
        name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_management_project = cls(
            name=name,
            version_creation_timeout=version_creation_timeout,
        )

        update_management_project.additional_properties = d
        return update_management_project
