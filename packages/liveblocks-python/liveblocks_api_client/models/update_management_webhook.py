...
T = TypeVar("T", bound="UpdateManagementWebhook")


@_attrs_define
class UpdateManagementWebhook:
    """
    Attributes:
        url (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_management_webhook.additional_properties = d
        return update_management_webhook
