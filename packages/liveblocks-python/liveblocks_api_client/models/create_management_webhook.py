...
if TYPE_CHECKING:
    from ..models.create_management_webhook_additional_headers import CreateManagementWebhookAdditionalHeaders


T = TypeVar("T", bound="CreateManagementWebhook")


@_attrs_define
class CreateManagementWebhook:
    """
    Attributes:
        url (str):
        subscribed_events (list[ManagementWebhookEvent]):
        rate_limit (float | Unset):
        additional_headers (CreateManagementWebhookAdditionalHeaders | Unset):
    ...
    additional_headers: CreateManagementWebhookAdditionalHeaders | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_additional_headers, Unset):
            ...
            additional_headers = CreateManagementWebhookAdditionalHeaders.from_dict(_additional_headers)
        ...
        create_management_webhook.additional_properties = d
        return create_management_webhook
