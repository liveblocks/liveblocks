...
from ..models.create_ai_copilot_provider import CreateAiCopilotProvider
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.copilot_settings import CopilotSettings
    from ..models.create_ai_copilot_provider_options_type_0 import CreateAiCopilotProviderOptionsType0
    from ..models.create_ai_copilot_provider_options_type_1 import CreateAiCopilotProviderOptionsType1
    from ..models.create_ai_copilot_provider_options_type_2 import CreateAiCopilotProviderOptionsType2


T = TypeVar("T", bound="CreateAiCopilot")


@_attrs_define
class CreateAiCopilot:
    """
    Attributes:
        name (str):
        system_prompt (str):
        ...
        provider_model (str):
        provider (CreateAiCopilotProvider):
        description (None | str | Unset):
        knowledge_prompt (None | str | Unset):
        always_use_knowledge (bool | None | Unset):
        provider_options (CreateAiCopilotProviderOptionsType0 | CreateAiCopilotProviderOptionsType1 |
            CreateAiCopilotProviderOptionsType2 | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.provider_options, CreateAiCopilotProviderOptionsType0):
            provider_options = self.provider_options.to_dict()
        elif isinstance(self.provider_options, CreateAiCopilotProviderOptionsType1):
            provider_options = self.provider_options.to_dict()
        elif isinstance(self.provider_options, CreateAiCopilotProviderOptionsType2):
            provider_options = self.provider_options.to_dict()
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider = CreateAiCopilotProvider(d.pop("provider"))
        ...
        def _parse_provider_options(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_options_type_0 = CreateAiCopilotProviderOptionsType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_options_type_1 = CreateAiCopilotProviderOptionsType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_options_type_2 = CreateAiCopilotProviderOptionsType2.from_dict(data)
        ...
        create_ai_copilot.additional_properties = d
        return create_ai_copilot
