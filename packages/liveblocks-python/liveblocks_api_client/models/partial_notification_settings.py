...
T = TypeVar("T", bound="PartialNotificationSettings")


@_attrs_define
class PartialNotificationSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partial_notification_settings = cls(
            email=email,
            slack=slack,
            teams=teams,
            web_push=web_push,
        ...
        partial_notification_settings.additional_properties = d
        return partial_notification_settings
