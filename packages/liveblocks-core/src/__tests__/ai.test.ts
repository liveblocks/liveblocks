...
describe("patchContentWithDelta", () => {
  describe("text-delta", () => {
    it("should append text delta to existing text part", () => {
    ...
    it("should create new text part if last part is not text", () => {
      const content: AiAssistantContentPart[] = [
    ...
    it("should create new text part when content is empty", () => {
      const content: AiAssistantContentPart[] = [];
      const delta: AiTextDelta = { type: "text-delta", textDelta: "Hello" };
  ...
  describe("reasoning-delta", () => {
    it("should append reasoning delta to existing reasoning part", () => {
      const content: AiAssistantContentPart[] = [
    ...
    it("should create new reasoning part if last part is not reasoning", () => {
      const content: AiAssistantContentPart[] = [
  ...
  describe("tool-invocation", () => {
    it("should add new receiving tool invocation when none exists", () => {
      const content: AiAssistantContentPart[] = [];
    ...
    it("should replace existing tool invocation with same invocationId", () => {
      const content: AiAssistantContentPart[] = [
        { type: "text", text: "Some text" },
        {
          type: "tool-invocation",
    ...
    it("should replace tool invocation (even if it's not the last part)", () => {
      const content: AiAssistantContentPart[] = [
        {
          type: "tool-invocation",
          stage: "receiving",
    ...
    it("should add multiple tool invocations with different IDs", () => {
      const content: AiAssistantContentPart[] = [];
  ...
  describe("edge cases", () => {
    it("should mutate the original content array", () => {
      const content: AiAssistantContentPart[] = [];
    ...
    it("should handle complex mixed content updates", () => {
      const content: AiAssistantContentPart[] = [
