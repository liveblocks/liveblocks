...
type AiConnectionErrorContext = {
  ...
  code: -1 | 4001 | (number & {}); // eslint-disable-line @typescript-eslint/no-empty-object-type
};

type RoomConnectionErrorContext = {
  type: "ROOM_CONNECTION_ERROR";
  code: -1 | 4001 | 4005 | 4006 | (number & {}); // eslint-disable-line @typescript-eslint/no-empty-object-type
  roomId: string;
};
