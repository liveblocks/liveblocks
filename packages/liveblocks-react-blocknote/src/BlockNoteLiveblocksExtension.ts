...
export type LiveblocksExtensionOptions = Parameters<typeof useTipTapLiveblocksExtension>[0];

export const useLiveblocksExtension = (options: LiveblocksExtensionOptions = {}) => {
  const extension = useTipTapLiveblocksExtension({ mentions: false, ...options });
