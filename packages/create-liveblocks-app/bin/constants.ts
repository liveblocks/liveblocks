const useProductionWebsite = !process.env.LOCALHOST_DEMO;

if (!useProductionWebsite) {
  console.warn("TESTING ON LOCALHOST\n");
}

export const LIVEBLOCKS_URL = useProductionWebsite
  ? "https://liveblocks.io"
  : "http://localhost:3001";
...
export const EXAMPLE_VERCEL_DEPLOYMENT_URL = (
  ...
  useProductionWebsite
    ? // Redirects back to liveblocks.io
    ...
    : // Redirects back to localhost:3001
      `https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fliveblocks%2Fliveblocks%2Fblob%2Fmain%2Fexamples%2F${exampleName}&developer-id=oac_cem0SgRkffaXn20Xd8wYxl8V&integration-ids=oac_cem0SgRkffaXn20Xd8wYxl8V&external-id=${encodedData}&project-name=${projectName}&repository-name=${projectName}`;

export const LIVEBLOCKS_GENERAL_INTEGRATION_URL = (encodedData: string) =>
  `${LIVEBLOCKS_URL}/integrations/general?data=${encodedData}`;
...
export const NEXTJS_STARTER_KIT_VERCEL_DEPLOYMENT_URL = (
  ...
  useProductionWebsite
    ...
    : // Redirects back to localhost:3001
      `https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fliveblocks%2Fliveblocks%2Fblob%2Fmain%2Fstarter-kits%2Fnextjs-starter-kit&developer-id=oac_cem0SgRkffaXn20Xd8wYxl8V&demo-title=Liveblocks%20Starter%20Kit&demo-description=Kickstart%20your%20collaborative%20app%20with%20Liveblocks%20and%20Next.js&demo-url=https%3A%2F%2Fliveblocks.io%2Fdocs%2Fguides%2Fnextjs-starter-kit&demo-image=https%3A%2F%2Fliveblocks.io%2Fimages%2Fintegrations%2Fnextjs-starter-kit-preview.png&integration-ids=oac_cem0SgRkffaXn20Xd8wYxl8V&external-id=${encodedData}&project-name=${projectName}&repository-name=${projectName}`;
