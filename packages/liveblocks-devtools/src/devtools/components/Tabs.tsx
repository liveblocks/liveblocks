...
import { type ComponentProps, type ReactNode,useCallback,useEffect, useId } from "react";
...
interface TabsProps extends Omit<RadixTabs.TabsProps, "defaultValue" | "value" | "onValueChange"> {
...
export function Tabs({
  ...
  const [
    activeTab,
    setActiveTab,
  ] = useStorage(`tabs-active-tab-${id}`, defaultTab);
  ...
  return (
    <RadixTabs.Root value={activeTab} onValueChange={handleTabChange} className={cx(className, "flex flex-col")} {...props}>
