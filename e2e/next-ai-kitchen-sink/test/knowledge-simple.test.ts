...
test.describe("Knowledge Registration - Simple", () => {
  test("should open knowledge page and interact with AI chat", async ({ page }) => {
    ...
    await expect(page.locator('text=What is the current view in the app?').first()).toBeVisible();
