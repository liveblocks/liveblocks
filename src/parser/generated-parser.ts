...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c15 = function (text: any): any {
  ...
  const peg$c25 = function (name: any): any {
    return ast.TypeName(name, rng());
  };
  const peg$c26 = function (first: any, x: any): any {
    return x;
  };
  const peg$c27 = function (first: any, rest: any): any {
    return [first, ...rest];
  };
  const peg$c28 = function (name: any, obj: any): any {
    return ast.ObjectTypeDef(name, obj, rng());
  };
  const peg$c29 = function (fields: any): any {
    return ast.ObjectLiteralExpr(fields, rng());
  };
  const peg$c30 = function (first: any, def: any): any {
    return def;
  };
  ...
  const peg$c32 = function (first: any, type: any): any {
    return type;
  };
  const peg$c33 = function (name: any, args: any): any {
    return args;
  };
  const peg$c34 = function (name: any, args: any): any {
  ...
  const peg$c43 = function (rawValue: any): any {
    const value = unescape(rawValue.substring(1, rawValue.length - 1)); // strip off quotes
