...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c32 = function(name: any, args: any): any { return ast.InstantiatedType(name, args, rng()) };
  ...
  function peg$parseInstantiatedType(): any {
    let s0, s1, s2, s3, s4;
