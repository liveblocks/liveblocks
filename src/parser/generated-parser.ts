...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c0 = function (defs: any): any {
    return ast.Document(
      ...
      // consumed and recorded, so tools like
      options?.comments
    );
  };
  ...
  const peg$c13 = function (text: any): any {
  ...
  const peg$c20 = peg$otherExpectation("type name");
  const peg$c21 = function (name: any): any {
    return ast.TypeName(name, rng());
  };
  const peg$c22 = function (first: any, def: any): any {
    return def;
  };
  const peg$c23 = function (first: any, rest: any): any {
    return [first, ...rest];
  };
