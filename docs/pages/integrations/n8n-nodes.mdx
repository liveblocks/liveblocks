...
| **Storage**      | Get, initialize, patch (JSON Patch), or delete Storage documents.                                                                                                       |
...
[`commentCreated`](/docs/api-reference/webhook-events#CommentCreatedEvent),
[`commentDeleted`](/docs/api-reference/webhook-events#CommentDeletedEvent),
[`commentEdited`](/docs/api-reference/webhook-events#CommentEditedEvent),
`notification`,
[`storageUpdated`](/docs/api-reference/webhook-events#StorageUpdatedEvent),
[`threadCreated`](/docs/api-reference/webhook-events#ThreadCreatedEvent),
[`threadDeleted`](/docs/api-reference/webhook-events#ThreadDeletedEvent),
[`threadMetadataUpdated`](/docs/api-reference/webhook-events#ThreadMetadataUpdatedEvent),
[`userEntered`](/docs/api-reference/webhook-events#UserEnteredEvent),
[`userLeft`](/docs/api-reference/webhook-events#UserLeftEvent), and
[`ydocUpdated`](/docs/api-reference/webhook-events#YDocUpdatedEvent). The
trigger verifies the request using your **webhook secret** before running the
workflow.
