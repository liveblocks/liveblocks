...
Quickstart for synching Liveblocks data to Neon. In this example, we sync Sync
Storage data to Neon, but you can use the same pattern with other APIs and
...
<Steps>
  ...
  <Step>
    <StepTitle>Storage to Neon</StepTitle>
    <StepContent>
...
second. Treat Neon as an eventually consistent mirror, not as the live editing
channel.
