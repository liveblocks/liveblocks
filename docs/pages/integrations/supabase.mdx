...
meta:
  ...
  description:
    "Use Supabase with Liveblocks to mirror realtime collaboration data into
    Postgres for reporting, search, audit logs, and application workflows."
---

Use Supabase with Liveblocks when your collaborative app needs a Postgres copy
of Liveblocks data for reporting, search, audit logs, or app workflows.

Liveblocks remains the source of truth for
...
[Threads](/docs/collaboration-features/comments/concepts). Supabase stores the
mirrored records you choose to write from your backend.
...
Liveblocks should remain the source of truth for Comments and Threads. Use
Supabase as an index for reporting, search, moderation, or audits.
