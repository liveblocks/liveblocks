...
Quickstart for synching Liveblocks data to PlanetScale. In this example, we sync
Storage data to PlanetScale, but you can use the same pattern with other APIs
and webhooks to sync other types of data.
...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      [host your local project](/docs/guides/how-to-test-webhooks-on-localhost).
      Subscribe to
  ...
  <Step>
    <StepTitle>Synchronize Sync data to PlanetScale</StepTitle>
    <StepContent>
...
second. Treat PlanetScale as an eventually consistent mirror, not as the live
editing channel.
...
- [Synchronize Storage document data to PlanetScale MySQL](/docs/guides/how-to-synchronize-your-liveblocks-storage-document-data-to-a-planetscale-mysql-database).
