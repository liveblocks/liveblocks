...
meta:
  ...
  description:
    "Add Liveblocks to apps built or exported from v0 so you can ship realtime
    presence, multiplayer editors, and comments alongside generated UI."
---

[v0](https://v0.app/) helps you generate full-stack apps quickly using AI chats.
With Liveblocks, you can add realtime collaboration to your generated v0 app,
such as [collaborative text editing](/docs/use-cases/text-editor),
...
<Step>
  ...
  <Step>
    ...
    <StepContent>
      During the process, v0 will prompt you to
      ...
      To manually edit your key in v0, go to Settings → Environment
      Variables → `LIVEBLOCKS_SECRET_KEY`.
    </StepContent>
...
To fix issues related to API keys, instruct v0 to use a secret key instead of a
public key, and authenticate your Liveblocks application.
