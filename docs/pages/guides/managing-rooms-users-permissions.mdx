...
There’s currently one permission type, with more coming soon:

<dl>
  <dt>room:write</dt>
  <dd>Enables people to view and edit the room.</dd>
</dl>
...
To allow a "engineering" group access to a room, we can use the
