...
A schema body is a multi-line string using the Liveblocks <link>schema syntax</link>. In the dashboard, a sample
...
In order to attach a schema to a room, you must first create a room and initialize storage. 
