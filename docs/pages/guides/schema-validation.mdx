...
Schemas are versionned to facilitate migrations. To attach a schema to a room,
you need to specify a version. A version id take the form
...
parameters. First, we will relace:
