...
When a schema is sent to the API it needs to be constructed as a string literal
to be valid JSON when sent to the API for parsing. In the dashboard, a sample
