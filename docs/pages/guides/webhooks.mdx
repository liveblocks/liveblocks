...
A user enters a room when they connect to a room, which is when this event is triggered. The number of active users is the number of users in the room after the
user has entered.
...
A user leaves a room when they disconnect from a room, which is when this event is triggered. The number of active users is the number of users in the room 
