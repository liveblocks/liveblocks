...
A user enters a room when they connect to a room. This event is triggered when a
user enters a room. The number of active users is the number of users after the
user has entered.
...
A user leaves a room when they disconnect from a room. This event is triggered
when a user leaves a room. The number of active users is the number of users
