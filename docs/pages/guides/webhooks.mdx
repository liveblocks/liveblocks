...
### Use Cases
Before webhooks, if you wanted to update internal data based on Liveblocks'
...
## Security
Webhooks can generate security holes, but with verification can be mitigated. When you verify your webhooks, you
