...
The major release of 1.0 marks the maturity of Liveblocks. The primary change
you should note is the transition to making the `userId` mandatory in the
`authorize` option. This change is in line with our
[new pricing model](https://liveblocks.io/pricing).

Let’s take a look!

## Upgrading to Liveblocks 1.0
