...
To update `@liveblocks/react` to .19, run the following command using your
...
We’ve added support to prevent the "zombie-child"/stale props scenario. To avoid
...
To update `@liveblocks/redux` to .19, run the following command using your
preferred package manager:

```bash
npm install @liveblocks/client@.19 @liveblocks/redux@.19
```
...
To update `@liveblocks/zustand` to .19, run the following command using your
preferred package manager:

```bash
npm install @liveblocks/client@.19 @liveblocks/zustand@.19
```
