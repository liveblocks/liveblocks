...
Our DevTools are currently only available if you are on Liveblocks 1.0 or later.
To view step-by-step instructions on how to upgrade your project to Liveblocks
1.0, check out our [upgrade guides](/guides/upgrading/).
...
storage panel represents each object that you have defined in storage as a tree,
likewise, the presence panel represents each user that is connected to your
Liveblocks project.
