...
7. Place your secret key into the file as `LIVEBLOCKS_SECRET_KEY`.
...
- [Demo authentication (skip to next section)](#how-to-sign-up)
...
[add yourself a user](#how-to-sign-up) to test out your authentication.
...
These functions can also be leveraged on the client side. To do so, simply
import from the `/lib/client` folder, and omit `res` and `res` instead. This
works by calling an API endpoint for you and then calling the `/lib/server`
function.
...
`/pages/api/auth/[...nextAuth].ts` and place your providers in the object:
...
```html file="File structure" isCollapsed isCollapsable
|____components - Components used in the app | |____Whiteboard |
|____ShareDialog | |____Document | |____Dashboard | |____Logo | |____Marketing |
|____Documents | |____Cursors | |____Badge |____data - A demo database
|____layouts - Page layout components | |____Authenticated | |____Document |
|____Dashboard | |____Marketing | |____Documents | |____Error |
|____Authentication |____icons |____lib | |____server - Server functions used
for accessing documents, database, liveblocks | | |____database | | |
|____getGroup.ts | | | |____getUser.ts | | | |____getGroups.ts | | |
|____index.ts | | |____notify | | | |____notify.ts | | | |____index.ts | |
|____auth | | | |____getServerSession.ts | | | |____index.ts | | |____utils | |
| |____buildDocumentUsers.ts | | | |____fetchLiveblocksApi.ts | | |
|____userAllowedInRooms.ts | | | |____getDraftsGroupName.ts | | |
|____convertAccessType.ts | | | |____buildDocuments.ts | | |
|____buildDocumentGroups.ts | | | |____isUserDocumentOwner.ts | | |
|____index.ts | | | |____getRandom.ts | | |____index.ts | | |____documents | | |
|____getDocuments.ts | | | |____getLiveUsers.ts | | | |____updateUserAccess.ts |
| | |____getDocumentGroups.ts | | | |____deleteDocument.ts | | |
|____createDocument.ts | | | |____updateGroupAccess.ts | | |
|____getNextDocuments.ts | | | |____updateDefaultAccess.ts | | |
|____updateDocument.ts | | | |____getDocumentUsers.ts | | |
|____removeUserAccess.ts | | | |____index.ts | | | |____getDocument.ts | | |
|____removeGroupAccess.ts | | |____liveblocks | | | |____getNextRooms.ts | | |
|____initializeStorage.ts | | | |____getActiveUsers.ts | | | |____getStorage.ts
| | | |____createRoom.ts | | | |____getActiveUsersInRooms.ts | | |
|____deleteRoom.ts | | | |____updateRoom.ts | | | |____deleteStorage.ts | | |
|____getRooms.ts | | | |____getRoom.ts | | | |____authorize.ts | | |
|____index.ts | |____client - Client functions used for accessing documents,
database, SWR hooks | | |____database | | | |____getGroup.ts | | |
|____getUser.ts | | | |____getGroups.ts | | | |____index.ts | | |____utils | | |
|____getDocumentAccess.ts | | | |____fetchApiEndpoint.ts | | | |____index.ts | |
|____hooks | | | |____useDocumentsFunctionSWR.ts | | | |____index.ts | | |
|____usePaginatedDocumentsSWR.ts | | |____index.ts | | |____documents | | |
|____getDocuments.ts | | | |____getLiveUsers.ts | | | |____updateUserAccess.ts |
| | |____updateDocumentName.ts | | | |____getDocumentGroups.ts | | |
|____deleteDocument.ts | | | |____createDocument.ts | | |
|____updateGroupAccess.ts | | | |____getNextDocuments.ts | | |
|____updateDefaultAccess.ts | | | |____getDocumentUsers.ts | | |
|____removeUserAccess.ts | | | |____index.ts | | | |____getDocument.ts | | |
|____removeGroupAccess.ts |____tsconfig.json |____pages - Next.js pages |
|____index.tsx | |____whiteboard | | |____[id].tsx | |____index.module.css |
|____dashboard | | |____index.tsx | | |____drafts.tsx | | |____group | | |
|____[groupId].tsx | |____api | | |____database | | | |____groups.ts | | |
|____users.ts | | |____auth | | | |____[...nextauth].ts | | |____liveblocks | |
| |____documents | | | | |____next.ts | | | | |____[documentId] | | | | |
|____defaultAccess.ts | | | | | |____groups.ts | | | | | |____users.ts | | | | |
|____index.ts | | | | |____liveUsers.ts | | | | |____index.ts | | | |
|____create.ts | | | |____auth.ts | |_____app.tsx | |____signin.tsx
|____primitives | |____Tooltip | |____Input | |____Skeleton | |____Checkbox |
|____Spinnerx | |____Dialog | |____Popover | |____Container | |____Button |
|____Avatar | |____Select |____styles | |____normalize.css | |____globals.css
|____types |____utils - Handy utils |____constants.ts |____liveblocks.config.ts
|____liveblocks.server.config.ts |____next.config.js |____next-auth.d.ts
|____next-env.d.ts |
```
