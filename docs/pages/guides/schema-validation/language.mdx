...
We currently support the following schema types: `Scalars`, `Object` and
`LiveObject` during the private beta. We’re sharing our plans for other syntaxes
so you can give us early feedback [here](TODO).
