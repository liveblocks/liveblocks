...
Currently in the private beta phase we support: scalars, arrays, objects,
optionals, `LiveObject`, `LiveList`, `LiveMap`, and most unions. We’re sharing
our plans for other syntaxes so you can give us early feedback
...
Literal types are also supported, for example:
