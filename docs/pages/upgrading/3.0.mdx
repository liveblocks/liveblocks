...
**If you’re using [Comments](/docs/collaboration-features/comments) and/or
[Text Editor](/docs/collaboration-features/multiplayer/text-editor)**, please read about
[changes to mentions](#mentions).

**If you’re using [Notifications](/docs/collaboration-features/notifications)**,
please read about
...
2.24 [introduced a few naming changes](/docs/upgrading/2.24) around the
...
- The deprecated aliases from the
  [2.24 naming changes](/docs/upgrading/2.24) have been removed, use
