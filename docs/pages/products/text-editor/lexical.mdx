...
[opens the new annotation composer](/docs/api-reference/liveblocks-react-lexical#Opening-the-FloatingComposer)
...
Add [`useThreads`](/docs/products/comments/hooks#threads-hook) to render your
...
```tsx
import { useHistoryVersions, HistoryVersionSummaryList } from "@liveblocks/react";
