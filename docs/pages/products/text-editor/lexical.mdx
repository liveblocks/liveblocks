...
// Room provider // Text visible on the dashboard

## Users and Mentions

// Same as comments but for text mention // Authentication, resolveUser and
resolveMentionsSuggestions // Not sure if we should duplicate
