...
Notifications is enabled by default, follow our
...
Learn more about
[sending email notifications with Notifications](/docs/products/notifications/email-notifications).

---

enabling real-time cursors, comments, and mentions.
