...
other parts of Liveblocks, such as [Comments](/docs/products/comments) and
[text editors](/docs/use-cases/text-editor), can also automatically trigger
collaboration notifications where appropriate.
...
<ListGrid columns={2}>
  ...
  <ExampleCard
    example={{
      ...
      slug: "comments-emails/nextjs-comments-emails-resend",
  ...
  <ExampleCard
    example={{
      ...
      slug: "collaborative-text-editor-emails/nextjs-tiptap-emails-resend",
