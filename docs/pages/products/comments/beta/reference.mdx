...
{/* TODO: Explain customization (CSS variables, dark mode, classes, classes with ":" are private, data attributes (e.g. data-resolved, data-self, data-loading) etc.) */}
...
{/* TODO: Explain how the default behavior can be overridden using event.preventDefault() and calling the mutation methods manually */}
