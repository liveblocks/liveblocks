...
[default components](/docs/products/comments/default-components), or
[primitives](/docs/products/comments/primitives). Here’s an example of it used
with the default [`Thread`](/docs/api-reference/liveblocks-react-ui#Thread)
component.
...
set when [authenticating with Liveblocks](/docs/api-reference/authentication).
With the [`useUser`](/docs/api-reference/liveblocks-react#useUser) hook, you can
fetch a user’s information from their ID. This is particularly helpful when
building primitive components, as this allows you fetch their name, avatar, and
...
[primitives](/docs/products/comments/primitives).
