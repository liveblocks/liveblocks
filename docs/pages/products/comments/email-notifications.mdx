...
[how to send email notifications when inbox notifications are created](/docs/guides/how-to-send-email-notifications-when-inbox-notifications-are-created).
...
it, then you will receive an _inbox notification_ for it. For example, in the
image below, Quinn Elton and Emil Joyce are both participants.
...
notifications across your rooms. To send corresponding emails to your users
letting them know they have unread notifications in their inbox, you can use
webhooks.
...
minutes to each user, though this can be customized in the webhook dashboard.
...
Once you have the thread, and the inbox notification, you can use this
...
[how to send email notifications](/docs/guides/how-to-send-email-notifications-when-inbox-notifications-are-created)
