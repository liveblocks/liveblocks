...
[overview page](/docs/products/comments/email-notifications).

## Sending email notifications with webhooks

Using
[Liveblocks webhooks](/docs/api-reference/webhook-events#Liveblocks-events) you
can listen to a range of events such as comments being deleted, or comment
reactions being added. On [your dashboard](https://liveblocks.io/dashboard) you
can create a webhook for a project, and select which events you’d like to listen
to. You only need to select the `"notification"` webhook event for our
...
the comment bodies, helpful for custom styling.
...
- [`CommentCreatedEvent`](/docs/api-reference/webhook-events#CommentCreatedEvent)
- [`CommentEditedEvent`](/docs/api-reference/webhook-events#CommentEditedEvent)
- [`CommentDeletedEvent`](/docs/api-reference/webhook-events#CommentDeletedEvent)
- [`CommentReactionAddedEvent`](/docs/api-reference/webhook-events#CommentReactionAddedEvent)
- [`CommentReactionRemovedEvent`](/docs/api-reference/webhook-events#CommentReactionRemovedEvent)
- [`CommentMetadataUpdatedEvent`](/docs/api-reference/webhook-events#CommentMetadataUpdatedEvent)
- [`ThreadCreatedEvent`](/docs/api-reference/webhook-events#ThreadCreatedEvent)
- [`ThreadMetadataUpdatedEvent`](/docs/api-reference/webhook-events#ThreadMetadataUpdatedEvent)
- [`ThreadMarkedAsResolvedEvent`](/docs/api-reference/webhook-events#ThreadMarkedAsResolvedEvent)
- [`ThreadMarkedAsUnresolvedEvent`](/docs/api-reference/webhook-events#ThreadMarkedAsUnresolvedEvent)
...
- [`getThreadParticipants`](/docs/api-reference/liveblocks-node)
