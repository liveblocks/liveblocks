...
- Can be used alongside [primitives](/docs/products/comments/primitives).
...
- [Adding metadata to a new thread](/docs/api-reference/liveblocks-react-comments#Adding-thread-metadata)
- [Replying to a thread](/docs/api-reference/liveblocks-react-comments#Replying-to-a-thread)
- [Modifying a comment](/docs/api-reference/liveblocks-react-comments#Modifying-a-comment)
- [Custom behavior](/docs/api-reference/liveblocks-react-comments#Custom-behavior)
...
[`Comment`]: /docs/api-reference/liveblocks-react-comments#Comment
[`Thread`]: /docs/api-reference/liveblocks-react-comments#Thread
...
Learn more under
[styling and customization](/docs/products/comments/styling-and-customization).
