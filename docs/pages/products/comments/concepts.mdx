...
[image outlining a multiplayer room, with outlined threads on a whiteboard and
outlined comments in a thread]
...
[Image of thread with thread.comments[0] comment at top]
...
[Image of a thread with one comment saying "[Comment deleted]"]
