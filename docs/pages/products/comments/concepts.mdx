...
<Figure>
  <Image
    src="/assets/comments/comment-thread-room-relation.png"
    srcDark="/assets/comments/comment-thread-room-relation-dark.png"
...
[React hook](/docs/products/comments/hooks#threads-hook) or
...
Threads can also store [custom metadata](/docs/products/comments/metadata),
which is helpful for integrating them into your product.
...
<Figure>
  <Image
    src="/assets/comments/first-comment-in-thread.png"
    srcDark="/assets/comments/first-comment-in-thread-dark.png"
...
<Figure>
  <Image
    src="/assets/comments/comment-deleted.png"
    srcDark="/assets/comments/comment-deleted-dark.png"
    alt="Image of a thread with one comment saying [Comment deleted]"
    width={800}
    height={500}
  />
</Figure>
