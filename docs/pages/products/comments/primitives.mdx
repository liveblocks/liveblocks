...
[`asChild`](/docs/products/comments/primitives#Merge-with-your-design-system-components).
...
[mentions](/docs/api-reference/liveblocks-react-comments#primitives-Composer.Editor-Mention),
[links](/docs/api-reference/liveblocks-react-comments#primitives-Composer.Link),
and a
[suggestions selection popover](/docs/api-reference/liveblocks-react-comments#primitives-Composer.Suggestions).
...
[mentions](/docs/api-reference/liveblocks-react-comments#primitives-Comment.Mention)
and
[links](http://localhost:3001/docs/api-reference/liveblocks-react-comments#primitives-Comment.Link).

## Timestamp

The
[`Timestamp`](/docs/api-reference/liveblocks-react-comments#primitives-Timestamp)
...
```tsx highlight="12"
import { Timestamp } from "@liveblocks/react-comments";
import { useThreads } from "../liveblocks.config";
