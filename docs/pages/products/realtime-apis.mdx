...
Build a custom collaborative experience using Liveblocks Realtime APIs. This can
include anything from whiteboards, flowcharts, spreadsheets, and more.
...
<ListGrid columns={2}>
  <DocsCard
    type="technology"
    title="Yjs"
    href="/docs/products/realtime-apis/yjs"
  ...
  <DocsCard
    type="technology"
    title="Storage"
    href="/docs/products/realtime-apis/storage"
  ...
  <DocsCard
    type="technology"
    title="Presence"
    href="/docs/products/realtime-apis/presence"
  ...
  <DocsCard
    type="technology"
    title="Broadcast"
    href="/docs/products/realtime-apis/broadcast"
