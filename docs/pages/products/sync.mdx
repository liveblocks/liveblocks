...
<ListGrid columns={2}>
  <DocsCard
    ...
    description="Build collaborative editors with LiveText"
  ...
  <DocsCard
    ...
    description="Build collaborative node-based interfaces"
...
<ListGrid columns={2}>
  <DocsCard
    type="technology"
    title="LiveText"
    href="/docs/products/sync/data-types#livetext"
    description="Build new collaborative text editors"
