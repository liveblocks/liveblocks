...
Figma, Notion, or Linear. With Liveblocks Sync, you can make anything
multiplayer: rich text editors, whiteboards, flowcharts, forms, spreadsheets, or
fully custom interfaces.

Sync keeps your collaborative state synchronized and persisted, so you do not
need to operate sync infrastructure yourself. Conflict resolution, Presence,
history, and Storage are handled for you.

Depending on what you’re building, use LiveText or Yjs for text editors, or
build directly with `@liveblocks/client`, `@liveblocks/react`,
`@liveblocks/zustand`, or `@liveblocks/redux`.
...
<ListGrid columns={2}>
  ...
  <DocsCard
    ...
    visual={
      <DocsMultiplayerUndoRedoIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
    ...
    visual={
      <DocsSyncPresenceIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
    ...
    visual={
      <DocsAgenticEditingIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
    ...
    visual={
      <DocsVersionHistoryIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
    ...
    visual={
      <DocsBroadcastEventsIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
    ...
    visual={<DocsFeedsIcon className="stroke-product-icon-brand h-auto w-6" />}
  />
  <DocsCard
    type="technology"
  ...
  <DocsCard
    ...
    visual={
      <DocsIntegrationsIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
...
<ListGrid columns={2}>
  <DocsCard
    ...
    visual={
      <DocsTextEditorIcon className="stroke-product-icon-brand h-auto w-6" />
    }
  />
  <DocsCard
    type="technology"
