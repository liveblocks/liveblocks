...
Sync data can be modified from your back end, using the same conflict
resolution that enables multiplayer collaboration on the front end. This allows you to create initial
