...
You can read and edit Storage from the server, and allow AI agents to make
changes too. To learn more about how to do this, read the
[agentic editing](/docs/products/sync/agentic-editing) and
[server-side editing](/docs/products/sync/server-side-editing) pages.
