...
meta:
  ...
  description: "Learn about using Liveblocks with Lexical"
---
...
<Banner title="LiveText vs Yjs">
  Liveblocks Lexical only supports Yjs-backed collaboration. [Learn
  more](/docs/guides/livetext-vs-yjs).
</Banner>
...
[build a button yourself](/docs/api-reference/liveblocks-react-lexical#Opening-the-composer).
...
Choose a starting point for your Lexical editor.
