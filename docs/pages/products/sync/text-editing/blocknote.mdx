...
meta:
  ...
  description: "Learn about using Liveblocks with BlockNote"
---

Liveblocks BlockNote allows you to add collaboration to any
[BlockNote](https://blocknotejs.org/) text editor, along with a number of
related features. Each [collaborative room](/docs/concepts#Rooms) in your
...
other Liveblocks products such as [Comments](/docs/products/comments) and
[Notifications](/docs/products/notifications).

<Banner title="LiveText vs Yjs">
  Liveblocks BlockNote fully supports both [LiveText and Yjs-backed
...
<ListGrid columns={2} defaultVisibleItems={2}>
  <DocsCard
    ...
    description="Yjs-backed block-based text editor with Next.js"
    visual={<DocsNextjsIcon />}
  />
  <DocsCard
    type="technology"
    title="Get started with BlockNote and LiveText"
    href="/docs/get-started/nextjs-blocknote-storage"
    description="LiveText-backed block-based text editor with Next.js"
    visual={<DocsNextjsIcon />}
  />
  <DocsCard
    type="technology"
    ...
    description="Yjs-backed block-based text editor with React"
    visual={<DocsReactIcon />}
  />
  <DocsCard
    type="technology"
    title="Get started with BlockNote and LiveText"
    href="/docs/get-started/react-blocknote-storage"
    description="LiveText-backed block-based text editor with React"
    visual={<DocsReactIcon />}
  />
</ListGrid>
...
BlockNote uses Yjs-backed collaboration by default. You can opt into
...
`offlineSupport_experimental` stays Yjs-only, as do server-side editing with
...
Choose a starting point for your BlockNote editor.
