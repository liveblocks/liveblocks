...
<ListGrid columns={2} defaultVisibleItems={2}>
  ...
  <DocsCard
    ...
    href="/docs/get-started/nextjs-tiptap-yjs"
  ...
  <DocsCard
    type="technology"
    title="Get started with Tiptap and Yjs"
    href="/docs/get-started/react-tiptap-yjs"
...
Follow the [React](/docs/get-started/react-tiptap) or
[Next.js](/docs/get-started/nextjs-tiptap) Storage get started guides, or read
the full
