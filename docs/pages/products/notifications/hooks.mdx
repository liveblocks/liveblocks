...
building custom components, as this allows you fetch their name, avatar, and any
...
[Comments](/docs/products/comments) integrates seamlessly into Notifications,
and a number of hooks are provided to modify this behavior.
