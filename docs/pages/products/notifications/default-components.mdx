...
- Receive collaboration notifications automatically triggered by Liveblocks
  [Comments](/docs/products/comments) or
  [text editors](/docs/use-cases/text-editor).
...
Learn more under
[styling and customization](/docs/products/notifications/styling-and-customization).
