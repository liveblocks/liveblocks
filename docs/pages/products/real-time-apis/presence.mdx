...
in the same room. With Presence, you can assign custom properties to the current
user that other people in the room can see. Presence can be used for live
cursors, live selection, "is typing" indicators, and more.
