...
When [registering a tool](/docs/products/ai-copilots/tools#defining-tools), the
[`AiTool`][] component can be used to
[show tool progress and results](/docs/products/ai-copilots/tools) within AI
...
[human-in-the-loop tool action](/docs/products/ai-copilots/tools#human-in-the-loop-actions).
...
Learn more under
[styling and customization](/docs/products/ai-copilots/styling-and-customization):
