...
[back-end knowledge](/docs/products/ai-copilots/knowledge#Back-end-knowledge)
...
[when AI should use knowledge](/docs/products/ai-copilots/copilots#When-should-AI-use-knowledge)
