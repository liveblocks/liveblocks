...
Styling [default components](/docs/products/ai-copilots/default-components) is
enabled through a range of means, such as CSS variables, class names, and more.
It’s also possible to use [overrides](#Overrides-and-localization) to modify any
strings used in the default components, which is especially helpful for
localization.
...
[hooks](/docs/products/ai-copilots/hooks).
