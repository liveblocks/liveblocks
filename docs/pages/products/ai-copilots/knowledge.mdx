...
[tools](/docs/products/ai-copilots/tools) to create an AI assistant that can
take actions. For example, say you have a document on the current page. You can
use knowledge to share the document content with the AI, then create a tool that
allows AI to edit the document.
...
your [copilot](/docs/products/ai-copilots/copilots#Adding-back-end-knowledge).
...
[when AI should use back-end knowledge](/docs/products/ai-copilots/copilots#When-should-AI-use-knowledge)
...
After
[creating a copilot](/docs/products/ai-copilots/copilots#Creating-a-copilot) in
the [dashboard](/dashboard), you can navigate to the “Knowledge” tab to add
...
`webSearch` option in
[your copilot settings](/docs/products/ai-copilots/copilots#Web-search).
...
You can also
[limit the domains that the AI can search](/docs/products/ai-copilots/copilots#Limit-web-search-to-specific-domains)
