...
Every plan includes the full platform: [Sync](/docs/products/sync),
[Comments](/docs/products/comments),
[Notifications](/docs/products/notifications/concepts#Custom-notifications), the
...
[authentication endpoint](/docs/api-reference/authentication). This `userId`
generally comes from your database or your authentication provider.
