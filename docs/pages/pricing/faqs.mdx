...
Every plan includes the full platform: [Presence](/docs/products/sync/presence),
[Storage](/docs/products/sync/data-types), [Comments](/docs/products/comments),
[Custom Notifications](/docs/products/notifications/concepts#Custom-notifications),
[Feeds](/docs/use-cases/ai-collaboration),
[AI Copilots](/docs/products/ai-copilots), the [dashboard](/dashboard), SDKs,
and APIs. What changes between plans is your monthly credit allowance, seat
count, and the security and support features you get. After you've used your
credits, you keep using Liveblocks. Pro and Team are charged for overage at the
same metered rates. Free plans hit hard limits per feature.
