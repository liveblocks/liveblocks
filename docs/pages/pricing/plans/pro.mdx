...
| <LimitLabel href="/docs/api-reference/authentication" tooltip="Public key only recommended for prototyping.">Monthly anonymous connections</LimitLabel>                                                                                      | <Limits.ProMaxAnonymousConnections />             |
...
| <LimitLabel href="/docs/api-reference/webhook-events#StorageUpdatedEvent" tooltip="The frequency at which `yDocUpdated` (Yjs) and `storageUpdated` (Storage) events are sent to your webhook endpoint.">Webhook event frequency</LimitLabel> | <Limits.ProStorageUpdatedWebhookEventThrottle />  |
