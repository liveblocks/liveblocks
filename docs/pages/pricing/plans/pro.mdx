...
| <LimitLabel href="/docs/platform/webhooks#StorageUpdatedEvent" tooltip="The frequency at which `yDocUpdated` (Yjs) and `storageUpdated` (Storage) events are sent to your webhook endpoint.">Webhook event frequency</LimitLabel> | <Limits.ProStorageUpdatedWebhookEventThrottle />  |
