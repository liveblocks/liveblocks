...
Credits reset at the start of each billing cycle and don't roll over. Team
bundles range from <Limits.TeamAnnualCredits tier={600} /> to
<Limits.TeamAnnualCredits tier={3750} /> of monthly credits depending on your
tier. Once you've used your credits, additional usage is billed at the
pay-as-you-go rates below.
...
| Version history <InfoTooltip>APIs, hooks, and pre-built components to access the previous versions of the realtime data stored in rooms.</InfoTooltip>                                                                                                                         | <Limits.TeamVersionHistory />                                                              |
