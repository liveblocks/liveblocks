...
The Free plan includes a monthly amount of usage per feature at no cost. Unlike
paid plans, these are hard limits: when a meter reaches its included amount,
that feature pauses until limits reset at the start of the next billing cycle.
...
| <a href="/docs/platform/limits#What-is-a-monthly-active-room">Monthly active rooms</a>                                                                                                                                                                                         | <Limits.FreeComparePlansMonthlyActiveRoomsLabel /> |
