...
| <LimitLabel href="/docs/api-reference/liveblocks-client#LiveFile" tooltip="An immutable Storage reference to an uploaded file.">LiveFile</LimitLabel>             | Limited by the max file upload size for your plan                                                                    |
...
For large files such as images and videos, use `LiveFile` instead of storing
binary data or base64 strings in realtime data structures.
