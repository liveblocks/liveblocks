...
plans, you can pay for [additional usage](/docs/pricing/limits) as you go.
...
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------- |
| <a href="/docs/pricing/faqs#What-is-a-monthly-active-room">Monthly active rooms</a> | <Limits.ProMonthlyActiveRoomsIncluded />                                               | <Limits.ProMonthlyActiveRoomsOverage />           |
| <a href="/docs/platform/account-management/manage-team-members">Dashboard seats</a> | <Limits.ProTeamMembersPerAccount /> (Pro), <Limits.TeamTeamMembersPerAccount /> (Team) | <Limits.DashboardSeatsOveragePrice /> (Team only) |
...
Only companies on the Team plan can purchase extra dashboard seats, billed
monthly at <Limits.DashboardSeatsOveragePrice />. The Pro plan is limited to a
total of <Limits.ProTeamMembersPerAccount /> seats and cannot add extra seats.
...
Take a look at our [Limits](/docs/pricing/limits) documentation for the limits
