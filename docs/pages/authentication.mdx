...
apply these permissions yourself each time a user connects. [mention complex
...
- **Access token authentication** is best for prototyping, as it’s easy to set
  up. It’s also ideal if you’d prefer handle permissions yourself, without
  relying on Liveblocks. [mention complex permissions limitation]
