...
necessary for your rooms when using access tokens.
...
checked on the room itself.

## Choose a method

The next step is to choose your authentication method. If you don’t need
permission then access tokens are for you. ID tokens enable more powerful
permissions but require you to manually create rooms yourself.
