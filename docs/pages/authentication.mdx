...
<Banner title="Self-hosting Liveblocks?">

If you're running a self-hosted Liveblocks server, you can use a
[custom auth strategy](/docs/authentication/custom-auth) to mint your own
bearer tokens instead of Liveblocks' built-in token formats.
