---
meta:
  title: "Creating a multiplayer to-do list with React, Zustand, and Liveblocks"
  parentTitle: "Tutorials"
  description:
    "Build a multiplayer to-do list with React, Zustand, and Liveblocks"
---
...
```bash
npx create-react-app zustand-todo-app
```
...
```js highlight="6-14,32-34" file="src/App.js"
import React, { useEffect } from "react";
import useStore from "./store";
...
```js highlight="12-15,17" file="src/store.js"
import create from "zustand";
import { createClient } from "@liveblocks/client";
import { middleware } from "@liveblocks/zustand";
...
const useStore = create(
  middleware(
    ...
    { client, presenceMapping: { isTyping: true } }
  )
);
...
```js highlight="8-16,21-22,38-45" file="src/App.js"
import React, { useEffect } from "react";
import useStore from "./store";
...
```js highlight="14,17-25,30" file="src/store.js"
import create from "zustand";
import { createClient } from "@liveblocks/client";
import { middleware } from "@liveblocks/zustand";
...
```js highlight="13-16,29-31,42-46,49-63" file="src/App.js"
import React, { useEffect } from "react";
import useStore from "./store";
