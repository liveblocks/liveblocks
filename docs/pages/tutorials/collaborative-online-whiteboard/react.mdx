...
real time across clients. Users will also be able to see other users' selections, along with undo and redo actions.
...
```bash
npx create-react-app react-whiteboard --template typescript
```
...
```tsx file="src/index.tsx" highlight="6,10-12"
...
```tsx highlight="6,16-20" file="src/index.tsx"
import React from "react";
import ReactDOM from "react-dom";
import "./index.css";
import App from "./App";
...
```ts file="src/liveblocks.config.ts" highlight="8,10"
import { createClient } from "@liveblocks/client";
import { createRoomContext } from "@liveblocks/react";
...
```ts file="src/App.js" highlight="5,7-9,11-13,18-26,35-37"
import { useMap } from "./liveblocks.config";
...
```ts file="src/liveblocks.config.ts" highlight="8-9,11"
import { createClient } from "@liveblocks/client";
import { createRoomContext } from "@liveblocks/react";
...
```tsx file="src/App.tsx" highlight="1,6,7,11-13,19-26,31-33,45,50,55"
...
const Rectangle = ({ shape, id, onShapePointerDown, selectionColor }: RectangleProps) => {
  const { x, y, fill } = shape;
...
```ts file="src/App.ts" highlight="3-6,12-14"
/* ... */
...
```ts file="src/App.ts" highlight="7,13,17,20-26,28-41,46,47"
...
```ts file="src/App.ts" highlight="6,12,19,26,39,40"
...
```ts file="src/App.tsx" highlight="2,17"
const onShapePointerDown = (e: any, shapeId: string) => {
  history.pause();
  e.stopPropagation();
...
```tsx file="src/App.tsx" highlight="7,14,17,25,26"
import { useEffect, useState } from "react";
import {
  useMap,
  useMyPresence,
...
```ts file="src/liveblocks.config.ts" highlight="8-26"
import { createClient } from "@liveblocks/client";
import { createRoomContext } from "@liveblocks/react";
...
```ts file="src/App.tsx" highlight="8,10,20-24,36-42,50,52-60"
...
const Rectangle = memo(({ shape, id, onShapePointerDown, selectionColor }: RectangleProps) => {
