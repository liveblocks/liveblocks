...
```bash
npx create-react-app zustand-whiteboard
```

Then run the following command to install the Liveblocks packages and Zustand:
...
[middleware](/docs/api-reference/liveblocks-zustand#middleware) to your store
configuration.
...
```js file="src/store.js" highlight="12,16"
import create from "zustand";
import { createClient } from "@liveblocks/client";
import { middleware } from "@liveblocks/zustand";
...
```jsx file="src/App.js" highlight="7,10,13,20-30,33-43"
import { useEffect } from "react";
import useStore from "./store";
...
```js file="src/store.js" highlight="9-17,23-36"
import create from "zustand";
import { createClient } from "@liveblocks/client";
import { middleware } from "@liveblocks/zustand";
...
```jsx file="src/App.js" highlight="8,13,19-22"
import { useEffect } from "react";
import useStore from "./store";
...
```js file="src/store.js" highlight="7,20,23-25,30"
/* ... */
...
```jsx file="src/App.js" highlight="9,10,18-26,31,33,45,46,54,56-59"
import { useEffect } from "react";
import useStore from "./store";
...
```js file="src/store.js" highlight="14-21"
/* ... */
...
```jsx file="src/App.js" highlight="11,20-22"
import { useEffect } from "react";
import useStore from "./store";
...
```js file="src/store.js" highlight="8,14,19-41"
/* ... */
...
```jsx file="src/App.js" highlight="12,13,21,22"
import { useEffect } from "react";
import useStore from "./store";
...
```jsx file="src/App.js" highlight="14,15,33,34"
import { useEffect } from "react";
import useStore from "./store";
...
```js file="src/store.js" highlight="14,22"
/* ... */
...
```js file="src/store.js" highlight="11,20-26,29-32,38-46"
/* ... */
