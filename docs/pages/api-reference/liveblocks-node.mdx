...
The purpose of `@liveblocks/node` is to help you implement your custom
authentication backend, i.e. the blue "server" part of this diagram:
...
When calling the `authorize` function, you must pass a `userId`. Optionally,
