...
Type guard to check if a received event is a `ThreadNotificationEvent`.
...
This type guard is here to help you better identify that a `NotificationEvent`
is a `ThreadNotificationEvent` in the case you want to send emails when receving
this event.

The check is made against the event type, event data kind and event data
channel.

### isTextMentionNotificationEvent [# isTextMentionNotificationEvent]

Type guard to check if a received event is a `TextMentionNotificationEvent`.
...
This type guard is here to help you better identify that a `NotificationEvent`
is a `TextMentionNotificationEvent` in the case you want to send emails when
receving this event.
