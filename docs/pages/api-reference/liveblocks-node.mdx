...
When using
[text editor integrations](/docs/products/sync/integrations#official-packages), user
data is inserted into their live cursor within the editor, showing their name
and color. This data originates from the `userInfo` property.
...
[text editor integrations](/docs/products/sync/integrations#official-packages), user
data is inserted into their live cursor within the editor, showing their name
and color. This data originates from the `userInfo` property of the session.
