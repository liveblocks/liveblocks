...
When using
[text editor integrations](/docs/collaboration-features/multiplayer#Text-editor-integrations),
...
[accesses](/docs/authentication/permissions). For example, this
...
[enable batching in the dashboard](/docs/collaboration-features/notifications/concepts#Notification-batching).
