...
#### Liveblocks.getThreads [#get-threads] [@badge=Beta]
...
#### Liveblocks.createThread [#create-thread] [@badge=Beta]
...
#### Liveblocks.updateThreadMetadata [#update-thread-metadata] [@badge=Beta]
...
#### Liveblocks.createComment [#create-comment] [@badge=Beta]
...
comment and the content of the comment. The comment content contains a body
property which is an array of paragraphs, each containing text nodes, for
example:
...
Note that `content` corresponds to the `CommentBody` type exported from
`@liveblocks/node`.
...
#### Liveblocks.editComment [#edit-comment] [@badge=Beta]
...
#### Liveblocks.deleteComment [#delete-comment] [@badge=Beta]
...
#### Liveblocks.addCommentReaction [#add-comment-reaction] [@badge=Beta]
...
#### Liveblocks.removeCommentReaction [#remove-comment-reaction] [@badge=Beta]
