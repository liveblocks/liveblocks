...
Type guard to check if a received webhook event is a `ThreadNotificationEvent`.
...
This type guard is here to help you better identify that a `WebhookEvent` is a
`ThreadNotificationEvent` in the case you want to send emails when receving this
event.
...
This type guard is here to help you better identify that a `WebhookEvent` is a
`TextMentionNotificationEvent` in the case you want to send emails when receving
this event.
