...
Returns the contents of the room’s Storage tree. Throws an error if the room
isn’t found. This is a wrapper around the
...
By default, this will return your Storage as LSON, a custom Liveblocks format
that preserves information about the conflict-free data types used.
...
You can also retrieve storage as JSON, by passing `"json"` as the second
argument.
