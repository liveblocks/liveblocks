...
User notification settings is currently in private beta. If you would like
access to the beta, please [contact us](https://liveblocks.io/contact/sales).
We’d love to hear from you.

</Banner>

#### Liveblocks.getNotificationSettings [#get-users-userId-notification-settings]

Returns the user's notification settings. This a wrapper around the
[ADD REST API LINK]().
...
#### Liveblocks.updateNotificationSettings [#post-users-userId-notification-settings]

Updates the user's notification settings. This a wrapper around the
[ADD REST API LINK]().

```ts
const updatedSettings = liveblocks.updateNotificationSettings({
...
Deletes the user's notification settings. This a wrapper around the
[ADD REST API LINK]().
