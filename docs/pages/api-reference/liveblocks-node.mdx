...
complex permissions using [tenants](/docs/authentication/tenants) and
[accesses](/docs/authentication/permissions). For example, this user can only
see resources in the `acme-corp` tenant, and they’re part of a `marketing` group
within it.
