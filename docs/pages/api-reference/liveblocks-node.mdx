...
Groups allow you to manage collections of users and assign permissions to them.
This is useful for implementing team-based access control in your application.
...
// { type: "group", id: "engineering-team", memberIds: [...], ... }
console.log(group);
```
