...
#### Liveblocks.updateThreadMetadata [#post-rooms-roomId-threads-threadId-metadata] [@badge=Beta]
...
#### Liveblocks.deleteComment [#post-rooms-roomId-threads-threadId-comments-commentId] [@badge=Beta]
...
#### Liveblocks.removeCommentReaction [#post-rooms-roomId-threads-threadId-comments-commentId-add-reaction] [@badge=Beta]
...
[Remove Comment Reaction API](/docs/api-reference/rest-api-endpoints#post-rooms-roomId-threads-threadId-comments-commentId-add-reaction)
and returns no response.
