...
editor, powered by Yjs. It also adds realtime cursors, document persistence on
the cloud, comments, and mentions. Read our
[get started guides](/docs/get-started/multiplayer/text-documents) to learn more.
