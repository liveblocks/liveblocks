...
<PropertiesList title="Values">
  ...
  <PropertiesListItem name="submit" type="() => void">
    Submit the editor programmatically.
  </PropertiesListItem>
  <PropertiesListItem name="clear" type="() => void">
    Clear the editor programmatically.
  </PropertiesListItem>
  <PropertiesListItem name="select" type="() => void">
    Select the editor programmatically.
  </PropertiesListItem>
  <PropertiesListItem name="focus" type="() => void">
    Focus the editor programmatically.
  </PropertiesListItem>
  <PropertiesListItem name="blur" type="() => void">
    Blur the editor programmatically.
  </PropertiesListItem>
  <PropertiesListItem name="createMention" type="() => void">
    Start creating a mention at the current selection.
  </PropertiesListItem>
  <PropertiesListItem name="insertText" type="(text: string) => void">
    Insert text at the current selection.
  </PropertiesListItem>
  <PropertiesListItem name="attachFiles" type="() => void">
...
<PropertiesList>
  ...
  <PropertiesListItem name="showRoomName" type="boolean">
