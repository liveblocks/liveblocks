...
<PropertiesList>
  ...
  >
    ...
    attachments that are (being) uploaded via this composer, but not submitted
    yet. If you want to prevent unsaved changes with Liveblocks, but not for
    this composer, you can opt-out this composer instance by setting this prop
    to `false`.
  </PropertiesListItem>
  <PropertiesListItem
    name="onComposerSubmit"
