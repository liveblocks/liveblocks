  ...
  components={{
    FloatingToolbar: () => (
      <Composer.FloatingToolbar>
        ...
        <Composer.TextFormatToggle format="italic">
          Italic
        </Composer.TextFormatToggle>
      </Composer.FloatingToolbar>
    ),
...
<PropertiesList>
  <PropertiesListItem name="textFormats" type="ComposerBodyTextActiveFormats">
...
| Attribute       | Value                              |
| --------------- | ---------------------------------- |
| `data-selected` | Present when the link is selected. |
...
<PropertiesList>
  <PropertiesListItem name="format" type="ComposerBodyTextFormat" required>
    The text format to toggle.
  </PropertiesListItem>
  <PropertiesListItem
    name="onFormatChange"
    type="function"
    detailedType="(format: ComposerBodyTextFormat) => void"
  >
