...
To set up your collaborative Tiptap editor, you must add the
[`useLiveblocksExtension`](#useLiveblocksExtension) to your editor.
...
function ThreadOverlay({ editor }: { editor: Editor }) {
