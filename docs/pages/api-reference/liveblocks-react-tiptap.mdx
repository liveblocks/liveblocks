...
toolbar. Can also be placed inside [`FloatingToolbar`][].
...
Adds a section containing inline formatting actions such _bold_, _italic_,
...
```tsx
import { Icon, Toolbar } from "@liveblocks/react-tiptap";
...
created with [`Toolbar.Button`][] and [`Toolbar.Toggle`][].
