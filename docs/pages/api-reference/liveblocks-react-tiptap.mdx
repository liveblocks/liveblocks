...
mentions. Read our [get started guides](/docs/get-started/multiplayer/text-documents/tiptap) to
learn more. For Storage-backed collaboration, see
...
Learn more in our [get started guides](/docs/get-started/multiplayer/text-documents/tiptap).
...
the default Yjs collaboration mode (`collaborationMode: "yjs"`).
