...
add content before or after, or the toolbar’s options can be
...
change styles. You can add content before or after, or the toolbar’s options can
be [customized](#creating-a-custom-floating-toolbar).
