...
<PropertiesList title="Options">
  ...
  <PropertiesListItem name="storageMapping" type="StorageMapping">
    Optional mapping to synchronize Zustand state with Storage.
  </PropertiesListItem>
</PropertiesList>
