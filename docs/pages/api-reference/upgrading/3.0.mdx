...
**If you’re using [Comments](/docs/products/comments) and/or
[Text Editor](/docs/use-cases/text-editor)**, please read about
[changes to mentions](#mentions).

**If you’re using [Notifications](/docs/products/notifications)**, please read
about [a change related to notification settings](#notification-settings).
...
2.24 [introduced a few naming changes](/docs/api-reference/upgrading/2.24) around the
...
- The deprecated aliases from the
  [2.24 naming changes](/docs/api-reference/upgrading/2.24) have been removed, use
