...
- The `useMap`, `useList`, and `useObject` hooks. These have been deprecated
  ...
  [the 0.18 upgrade guide](/docs/api-reference/upgrading/0.18#Step-5a:-Replace-reads-with-useStorage)
...
- Remove legacy `authorize` method from `@liveblocks/node`. Please refer to
  [the 1.2 upgrade guide](/docs/api-reference/upgrading/1.2#how) to learn how to
