...
<Figure>
  <Image
    src="/assets/comments/inbox-notification.png"
...
<PropertiesList>
  ...
  >
    The component used to display thread inbox notifications. Defaults to
...
This hook has a number of uses, for example constructing a custom button that
submits threads, and disabling it when the composer input is empty.
