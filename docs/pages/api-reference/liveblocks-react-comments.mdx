...
Used to render a composer for creating threads or comments.
...
import { useUser } from "../liveblocks.config.ts";

// Render a custom composer with custom mentions and more
function MyComposer() {
  return (
    <Composer.Form>
      <Composer.Editor
