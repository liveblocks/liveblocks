...
| ------------------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- |
| `thread` <DocsRequired /> | <code>ThreadData&lt;\{ resolved?: boolean \}&gt;</code>                              | The thread to display.                                                                                      |
...
| `metadata`          | <code>ThreadMetadata&lt;T&gt;</code>                                                                                  | The metadata of the thread to create.                                                             |
