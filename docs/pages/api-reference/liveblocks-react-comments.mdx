...
() => (
  <Comment.Body
    renderMention={() => <Comment.Mention />}
    renderLink={(props) => <Comment.Link {...props} />}
  />
);
```
...
| `renderLink`    | <code>ComponentType&lt;CommentRenderLinkProps&gt; \| undefined</code>    | The component used to render links.<br/>Defaults to the link’s `children` property.             |
...
##### renderLink [#primitives-Comment.Body-renderLink]
...
() => (
  <Composer.Form>
    <Composer.Editor
      ...
      renderLink={(props) => <Composer.Link {...props} />}
    />
    <Composer.Submit />
  </Composer.Form>
);
...
| `renderLink`               | <code>ComponentType&lt;ComposerRenderLinkProps&gt; \| undefined</code>               | The component used to render links.<br/>Defaults to the link’s `children` property.                    |
...
##### renderLink [#primitives-Composer.Editor-renderLink]

A render prop that accepts a component used to render links.

```tsx
<Composer.Editor
  renderLink={({ href, children }) => <Composer.Link>{children}</Composer.Link>}
/>
```
