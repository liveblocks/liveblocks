...
| `indentBody`   | `boolean \| undefined`                                                                            | Whether to indent the comments’ bodies.<br/>Defaults to `true`.               |
...
| Attribute       | Value                                |
| --------------- | ------------------------------------ |
| `data-resolved` | Present when the thread is resolved. |
...
| Attribute      | Value                                |
| -------------- | ------------------------------------ |
| `data-deleted` | Present when the comment is deleted. |
