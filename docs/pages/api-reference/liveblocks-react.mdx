...
component whenever it changes. Can be helpful for
[preventing users from leaving your app before changes are saved](#prevent-users-losing-unsaved-changes).
