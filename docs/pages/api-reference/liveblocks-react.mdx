...
Returns a list of all AI chats created by the current user.
...
Map through `inboxNotifications`, passing each to
[`InboxNotification`](/docs/api-reference/liveblocks-react-ui#InboxNotification),
to render the latest 50 inbox notifications with our default UI components.
