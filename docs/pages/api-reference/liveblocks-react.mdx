...
This hook was renamed to [`useRoomSubscriptionSettings`][] in 2.23, read more in
our [migration guide](/docs/platform/upgrading/2.23).
...
This hook was renamed to [`useUpdateRoomSubscriptionSettings`][] in 2.23, read
more in our [migration guide](/docs/platform/upgrading/2.23).
