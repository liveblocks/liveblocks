...
and resolved status of the parent thread and presence and absense of attachments
and mentions in the comment.
...
<PropertiesList title="Arguments">
  ...
  <PropertiesListItem name="options.query" type="InboxNotificationsQuery">
    ...
    parent thread, and presensce and absense of attachments and mentions in the
    comment.
  </PropertiesListItem>
  <PropertiesListItem name="options.query.text" type="SearchThreadsQuery">
  ...
  <PropertiesListItem
    name="options.query.threadResolved"
    type="SearchThreadsQuery"
  >
  ...
  <PropertiesListItem
    name="options.query.hasAttachments"
    type="SearchThreadsQuery"
  >
    (Optional) Whether to only return comments that have attachments.
  </PropertiesListItem>
  <PropertiesListItem
    name="options.query.hasMentions"
    type="SearchThreadsQuery"
  >
