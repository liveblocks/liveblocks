...
<PropertiesList title="Props">
  ...
  >
    ...
    [Comments](/docs/collaboration-features/comments), [Text
    Editor](/docs/collaboration-features/multiplayer/text-editor), and
    [Notifications](/docs/collaboration-features/notifications). Return an array of
  ...
  >
    ...
    [Comments](/docs/collaboration-features/comments) and [Text
    Editor](/docs/collaboration-features/multiplayer/text-editor). Return an array of
  ...
  >
    ...
    [Comments](/docs/collaboration-features/comments) and [Text
    Editor](/docs/collaboration-features/multiplayer/text-editor). Return an array of user IDs
...
learn more in [authentication guide](/docs/authentication).
...
[Notifications](/docs/collaboration-features/comments/email-notifications), `room`
...
- There are unsaved changes in a
  [Text Editor](/docs/collaboration-features/multiplayer/text-editor).
...
[Text Editor](/docs/collaboration-features/multiplayer/text-editor) store user IDs in its
...
When using
[Notifications](/docs/collaboration-features/comments/email-notifications) with
[Comments](/docs/collaboration-features/comments), room IDs will be used to
...
When using group mentions with [Comments](/docs/collaboration-features/comments)
and [Text Editor](/docs/collaboration-features/multiplayer/text-editor), group IDs will be used
...
To enable creating mentions in [Comments](/docs/collaboration-features/comments)
and [Text Editor](/docs/collaboration-features/multiplayer/text-editor), you can provide a
...
To support group mentions in [Comments](/docs/collaboration-features/comments) and
[Text Editor](/docs/collaboration-features/multiplayer/text-editor), you can return a list of
...
[Sync Datastore](/docs/collaboration-features/multiplayer/sync-engine), initial Presence values for
...
the room, unlike [Presence](/realtime-infrastructure?primitive=presence) which is
temporary.
...
[project-based](/docs/collaboration-features/notifications/concepts#Project-based),
...
[2.0 migration guide](/docs/upgrading/2.0).
