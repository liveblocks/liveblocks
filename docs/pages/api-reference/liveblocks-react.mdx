...
Returns a paginated list of feeds within the current room. Initially fetches
feeds based on the provided options.
[Suspense](/docs/api-reference/liveblocks-react#Suspense-hooks) and
[regular](/docs/api-reference/liveblocks-react#Regular-hooks) versions of this
hook are available.
...
<PropertiesList title="Arguments">
  ...
  <PropertiesListItem name="options.since" type="number">
    Optional timestamp filter. Only feeds created or updated after this
    timestamp (ms) will be returned.
  </PropertiesListItem>
  <PropertiesListItem name="options.metadata" type="Record&lt;string, Json&gt;">
...
<PropertiesList title="Returns">
  <PropertiesListItem name="feeds" type="Feed[] | undefined">
    An array of feeds within the current room, or `undefined` if not yet loaded
    (in non-Suspense version).
  </PropertiesListItem>
  <PropertiesListItem name="isLoading" type="boolean">
...
room. Initially fetches messages based on the provided options.
[Suspense](/docs/api-reference/liveblocks-react#Suspense-hooks) and
[regular](/docs/api-reference/liveblocks-react#Regular-hooks) versions of this
hook are available.
...
<PropertiesList title="Returns">
  <PropertiesListItem name="messages" type="FeedMessage[] | undefined">
    An array of messages in the feed, or `undefined` if not yet loaded (in
