...
Liveblocks servers when mounted, so it can (and should) live higher in the
component tree of your app.
...
For advanced usage only. We generally recommend using ... TODO ... unless you
need to define multiple room types in your application.
