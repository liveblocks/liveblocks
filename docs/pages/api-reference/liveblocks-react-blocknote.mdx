...
Learn more in our [get started guides](/docs/get-started/multiplayer/text-documents/blocknote).
...
`offlineSupport_experimental` and `ai` require the default Yjs mode.
