...
Theses function also help you distinguish between _unread mentions_ and _unread
replies_.
...
Theses functions avoid repetition of unread comments (_unread mention_ or
_unread replies_) between two unread notifications. It means for example if a
user is notified two times because of _unread replies_ but do not reads the
notifications then the functions will not give you the same comments between the
two notifications. Unread comments from the first notification will not be
repeated in the result of the second notification.
