...
These functions avoid the repetition of unread comments (_unread mention_ or
_unread replies_) between two unread notifications. It means for example if a
user is notified two times because of _unread replies_ but does not read the
