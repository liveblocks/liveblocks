...
These functions help you create emails for notifying users about _unread
...
[resolve user/room data](#prepare-thread-notification-as-react-resolving-data)
and
[customize the components](#prepare-thread-notification-as-react-customizing-components).
...
<PropertiesList title="Arguments">
  ...
  >
    ...
    [Learn more](#prepare-thread-notification-as-react-resolving-data).
  </PropertiesListItem>
  <PropertiesListItem
  ...
  <PropertiesListItem name="options.components" type="object">
    ...
    more](#prepare-thread-notification-as-react-customizing-components).
  </PropertiesListItem>
  <PropertiesListItem
...
#### Resolving data [#prepare-thread-notification-as-react-resolving-data]
...
#### Customizing components [#prepare-thread-notification-as-react-customizing-components]

Each React component in the comment body can be replaced with a custom React
component, should you choose to use different styles. Five components are
available: `Container`, `Paragraph`, `Text`, `Link`, `Mention`.
...
[resolve user/room data](#prepare-thread-notification-as-html-resolving-data)
and
[customize the styles](#prepare-thread-notification-as-html-styling-elements).
...
if (isThreadNotificationEvent(event)) {
  // +++
  const emailData = await prepareThreadNotificationAsHtml(liveblocks, event);
  // +++
  let email;
...
<PropertiesList title="Arguments">
  ...
  >
    ...
    the
    client](/docs/api-reference/liveblocks-react#LiveblocksProviderResolveUsers).
    [Learn more](#prepare-thread-notification-as-html-resolving-data).
  </PropertiesListItem>
  <PropertiesListItem
    name="options.resolveRoomsInfo"
    detailedType="async? (args: ResolveRoomsInfoArgs) => (RoomInfo | undefined)[] | undefined"
  ...
  <PropertiesListItem name="options.styles" type="object">
    ...
    `link`, `mention`. [Learn
    more](#prepare-thread-notification-as-html-styling-components).
  </PropertiesListItem>
...
#### Resolving data [#prepare-thread-notification-as-html-resolving-data]
...
#### Styling elements [#prepare-thread-notification-as-html-styling-elements]

Each element in the comment body can be styled with custom CSS properties,
should you like to change the appearance. Five elements are available:
