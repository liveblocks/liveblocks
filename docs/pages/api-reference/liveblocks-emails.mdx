...
emails with [Notifications](/docs/collaboration-features/notifications) and
...
<PropertiesList title="Arguments">
  ...
  >
    ...
    [Comments](/docs/collaboration-features/comments). Return an array of
    `UserMeta["info"]` objects in the same order they arrived. Works similarly
    to the [resolver on the
    client](/docs/api-reference/liveblocks-react#LiveblocksProviderResolveUsers).
...
mention_ in a [Text Editor](/docs/collaboration-features/multiplayer/text-editor) document. In
...
[render multiple editors per page](/docs/collaboration-features/multiplayer/text-editor/tiptap#Multiple-editors),
...
<PropertiesList title="Arguments">
  ...
  >
    ...
    `UserMeta["info"]` objects in the same order they arrived. Works similarly
    to the [resolver on the
    client](/docs/collaboration-features/multiplayer/text-editor/lexical#Users-and-mentions).
    [Learn
