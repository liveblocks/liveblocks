...
mentions in paragraph blocks work, as there are limitations around retrieving
mentions in plugins.
...
[render multiple editors per page](/docs/products/text-editor/tiptap#Multiple-editors),
