...
#### Styling components [#prepare-thread-notification-as-html-styling-components]

Each element in the comment body can be style with custom CSS properties, should
you look to change the look of it. Five elements are available: `container`,
`paragraph`, `text`, `link`, `mention`.
