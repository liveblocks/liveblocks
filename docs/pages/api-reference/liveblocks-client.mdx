...
[Presence](/docs/ready-made-features/multiplayer) is used to store custom
...
Updates the current user’s [Presence](/docs/ready-made-features/multiplayer). Only
...
users have left the room, unlike [Presence](/docs/ready-made-features/multiplayer)
which is temporary.
