...
modified or deleted since the requested date. Helpful when used in combination
...
// { modified: [{ id: "th_s4368s...", type: "thread" }, ...], deleted: [...] }
console.log(threads);

// { modified: [{ id: "in_ds83hs...", kind: "thread", }, ...], deleted: [...] }
console.log(inboxNotifications);
```
...
threads since the requested date. Helpful when used in combination with
...
<PropertiesList title="Options">
  <PropertiesListItem name="since" type="Date">
    Only the inbox notifications modified or deleted after this date will be
    returned.
  </PropertiesListItem>
</PropertiesList>
