...
<PropertiesList title="Returns">
  ...
  >
    ...
    about [typing your room](#enter-room-typing-your-room).
  </PropertiesListItem>
...
#### Typing your room [#enter-room-typing-your-room]

It’s possible to have type hints on your room by passing types for your
Presence, Storage, UserMeta, and RoomEvents. Here are some example values.
...
type UserMeta = {
  id: string;
  info: {
    // Corresponds with userInfo set when authenticating with secret key
  };
};
...
<PropertiesList title="Returns">
  ...
  >
    ...
    about [typing your room](#get-room-typing-your-room).
  </PropertiesListItem>
</PropertiesList>
...
#### Typing your room [#get-room-typing-your-room]
...
[`User`](#user-type) object for each user.
...
`User` is a type that’s returned by [`room.getOthers`][], and other functions.

<PropertiesList title="Properties">
  <PropertiesListItem name="connectionId" type="number">
    The connection ID of the User. It is unique and increment at every new
    connection.
  </PropertiesListItem>
