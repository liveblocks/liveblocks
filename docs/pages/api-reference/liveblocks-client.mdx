...
Note that it’s possible to [add types to your room](#typing-your-room).
...
<PropertiesList title="Returns">
  ...
  <PropertiesListItem name="leave" type="() => void">
    A function that’s used to destroy the room.
  </PropertiesListItem>
</PropertiesList>
...
<PropertiesList title="Returns">
  <PropertiesListItem>_Nothing_</PropertiesListItem>
</PropertiesList>

<PropertiesList title="Arguments">
  <PropertiesListItem>_None_</PropertiesListItem>
</PropertiesList>
...
<PropertiesList title="Returns">
  ...
  >
    The current user’s Storage status. `status` can be one of four types.
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="event" type={`"event"`} required>
    Listen to events.
  </PropertiesListItem>
  <PropertiesListItem
    name="callback"
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="others" type={`"others"`} required>
    Listen to others.
  </PropertiesListItem>
  <PropertiesListItem
    name="callback"
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="status" type={`"status"`} required>
...
A [special-purpose event](#when-to-use-lost-connection-events) that will fire
when a previously connected Liveblocks client has lost connection, for example
due to a network outage, and was unable to recover quickly. This event will not
trigger on short interruptions, those that are less than
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="lost-connection" type={`"lost-connection"`} required>
...
Subscribe to our legacy WebSocket connection status updates. Takes a callback
that is called when the connection status changes. Returns an unsubscribe
function.
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="error" type={`"error"`} required>
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="history" type={`"history"`} required>
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="value" type="LsonObject" required>
    ...
    other Liveblocks conflict-free data structures.
  </PropertiesListItem>
</PropertiesList>
...
<PropertiesList title="Arguments">
  <PropertiesListItem
    name="callback"
    detailedType="(value: L, key: string) => void"
    required
  >
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="index" type="string" required>
...
<PropertiesList title="Returns">
  <PropertiesListItem name="value" type="L | undefined">
    The index of the item. Returns `undefined` if it doesn’t exist.
  </PropertiesListItem>
</PropertiesList>

<PropertiesList title="Arguments">
  <PropertiesListItem name="index" type="string" required>
    The value of the index you’re getting.
  </PropertiesListItem>
</PropertiesList>
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="index" type="L extends LsonObject" required>
    The value of the item you’re inserting.
  </PropertiesListItem>
  <PropertiesListItem name="index" type="index" required>
...
<PropertiesList title="Properties">
  ...
  <PropertiesListItem name="isReadOnly" type="boolean" deprecated>
    Deprecated. False if the user can mutate the Room’s Storage and/or YDoc,
