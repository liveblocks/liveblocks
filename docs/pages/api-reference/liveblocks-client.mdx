...
between different events on the receiving end. The `user` property received on
the other end is the sender’s [`User`](#user-type) instance.
...
that sent the message. If this event was sent via
