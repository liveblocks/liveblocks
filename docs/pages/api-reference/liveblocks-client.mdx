...
<PropertiesList title="Options">
  ...
  >
    ...
    - `"experimental-fallback-to-http"` Try sending the update over HTTP instead of WebSockets. This strategy is marked experimental, as it does not work with Liveblocks Storage yet.
