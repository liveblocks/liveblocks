...
Note that when using Notifications, the parameter `room` can be undefined. This
implies that the client is requesting a token that grants access to multiple
