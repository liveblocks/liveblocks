...
Keys should be strings, and values should be serializable to JSON. If multiple
...
<PropertiesList title="Arguments">
  <PropertiesListItem name="initialValue" type="L extends LsonObject" required>
    The initial value for the `LiveObject`. Can contain other Liveblocks data
    structures (`LiveList`, `LiveMap`) and JSON-compatible data.
  </PropertiesListItem>
</PropertiesList>
