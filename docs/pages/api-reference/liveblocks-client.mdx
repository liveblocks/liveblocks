...
[Text Editor](/docs/collaboration-features/multiplayer/text-editor) store user IDs in their
...
[Presence](/realtime-infrastructure?primitive=presence) is used to store custom
...
Updates the current user’s [Presence](/realtime-infrastructure?primitive=presence). Only
