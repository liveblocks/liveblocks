...
<PropertiesList title="Options">
  <PropertiesListItem name="query" type="object" optional>
...
Helpful when used in combination with [`Room.getThreads`]() to initially fetch
all threads, then update later.
...
<PropertiesList title="Arguments">
  <PropertiesListItem
    name="options"
    type="{ body: CommentBody, metadata: ThreadMetadata }"
  >
    `body`: The content of the comment. <br /> `metadata`: The thread metadata.
  </PropertiesListItem>
</PropertiesList>
...
Edits a thread's metadata. To delete an existing metadata property, set its
value to `null`.
...
<PropertiesList title="Arguments">
  <PropertiesListItem
    name="options"
    type="{ metadata: Patchable<ThreadMetadata>, threadId: string }"
  >
    `metadata`: An object containing the metadata properties to update.
    <br />
...
Returns the current user inbox notifications and their associated threads. It
...
<PropertiesList title="Returns">
  <PropertiesListItem name="inboxNotifications" type="InboxNotificationData[]">
    Current user inbox notifications.
  </PropertiesListItem>
  <PropertiesListItem name="threads" type="ThreadData[]">
    Threads associated to the inbox notifications.
  </PropertiesListItem>
  <PropertiesListItem name="requestedAt" type="Date">
    The request date to use for subsequent polling.
  </PropertiesListItem>
