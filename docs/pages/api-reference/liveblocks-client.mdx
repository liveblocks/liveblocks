...
<PropertiesList title="Arguments">
  ...
  <PropertiesListItem name="options.engine" type="1 | 2">
    ...
    effect if the room doesn’t exist yet. Engine 2 supports larger documents, is
    more performant, has native streaming support, and will become the default
    in the future. [Learn more](/docs/guides/the-new-storage-engine-and-its-benefits).
  </PropertiesListItem>
</PropertiesList>
