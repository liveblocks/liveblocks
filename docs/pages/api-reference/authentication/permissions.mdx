...
[ID token authentication](/docs/api-reference/authentication), permissions are
set on rooms. With
[access tokens](/docs/api-reference/authentication/access-token), you
permissions are granted when a user authenticates.
...
| `storage:read`           | Storage         | Read access to Storage and Yjs documents.   |
| `storage:write`          | Storage         | Write access to Storage and Yjs documents.  |
| `storage:none`           | Storage         | No access to Storage or Yjs documents.      |
...
[create or update rooms](/docs/api-reference/authentication#id-token-room-permissions).
With access tokens, use permissions when you
[allow access to rooms](/docs/api-reference/authentication/access-token#room-permissions)
in an authentication endpoint.
