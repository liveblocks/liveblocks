...
<Figure caption={<>A comment thread built with the default components</>}>
  <Image
    src="/assets/tutorials/comments/thread.png"
    alt="A comment thread showing replies from multiple users"
    width={1291}
    height={892}
  />
</Figure>
...
<ListGrid columns={2} defaultVisibleItems={4}>
  ...
  <DocsCard
    type="technology"
    title="Get started with in-app notifications"
    href="/docs/get-started/nextjs-notifications-in-app"
    description="Show an unread notification inbox"
    visual={<DocsNextjsIcon />}
  />
  <DocsCard
    type="technology"
    title="Get started with email notifications"
  ...
  <DocsCard
    type="technology"
    title="Get started with comments on a canvas"
...
[Notifications use case](/docs/use-cases/notifications) for a complete inbox,
unread badges, and user settings.
...
[AI collaboration](/docs/use-cases/ai-collaboration).
...
or learn more under [Permissions](/docs/authentication/permissions).
