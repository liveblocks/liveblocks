...
[conflict-free data types](/docs/products/sync/data-types). In this snippet, a
...
Learn more under [data types](/docs/products/sync/data-types) and
...
send a transient [broadcast event](/docs/products/sync/broadcast-events) to the
other connected clients, and
...
the full pattern, and learn more under
...
const { output: newLinks } = await generateText({
  ...
  prompt: `Add related links to this issue: …`,
});
// +++
