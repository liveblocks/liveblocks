...
<Figure caption={<>Live cursors built with the ready-made components</>}>
  <Image
    src="/assets/presence/cursors.png"
    alt="Live cursors showing the pointer positions of multiple users"
    width={768}
    height={461}
  />
</Figure>
...
[Storage](/docs/products/sync/data-types). Define the shape of your presence
object with the
