...
Store permanent slide content, order, and layout in
[Sync](/docs/products/sync/overview). Keep temporary cursors, selections, and
presentation state in [Presence](/docs/products/sync/presence). Use
[Comments](/docs/products/comments) for review discussions and
[Feeds](/docs/products/sync/feeds) for durable AI proposals and progress.
