...
The Liveblocks WebSocket edge network primarily uses Cloudflare Workers global
network which spans across 300 cities and 100+ countries, enabling you to be
~50ms away from 95% of the world’s internet-connected population.

## WebSocket connection engine

The Liveblocks WebSocket connection engine ensures a reliable real-time
