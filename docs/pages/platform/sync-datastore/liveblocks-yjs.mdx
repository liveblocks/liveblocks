...
If you’re using Tiptap or Lexical, we recommend using
...
those editors. Sync Datastore, powered by Storage and Yjs, is intended for use
in other editors, or for completely custom solutions.
