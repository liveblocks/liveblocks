...
When using [Comments](/docs/collaboration-features/comments), an event is triggered
...
When using [Text editor](/docs/collaboration-features/multiplayer/text-editor), an event is
