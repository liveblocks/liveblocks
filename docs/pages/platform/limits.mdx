...
| ------------------------------------ | --------------------------------------------- | -------------------------------------------- | ---------- |
| Monthly active users included        | <Limits.StarterMauMax />                         | <Limits.ProMauIncluded />                    | Custom     |
| Monthly active users limit           | <Limits.StarterMauMax />                         | <Limits.ProMauMax />                         | Unlimited  |
...
| Maximum storage size per room        | Up to <Limits.StarterMaxStorageSizePerRoom /> MB | Up to <Limits.ProMaxStorageSizePerRoom /> MB | Custom     |
| Simultaneous connections per room    | Up to <Limits.StarterMaxConnectionsPerRoom />    | Up to <Limits.ProMaxConnectionsPerRoom />    | Custom     |
| Monthly comments limit               | <Limits.StarterMaxCommentsCreatedPerMonth />     | <Limits.StarterMaxCommentsCreatedPerMonth />    | Custom     |
