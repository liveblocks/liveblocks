...
We allow up to 50K requests per secret key per 60 seconds when using our [REST API](/docs/api-reference/rest-api-endpoints) and [`@liveblocks/node`](/docs/api-reference/liveblocks-node).
