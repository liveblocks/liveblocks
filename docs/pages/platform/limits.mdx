...
| yDocUpdated webhook event throttle    | <Limits.StarterYdocUpdatedWebhookEventThrottle>    | <Limits.ProYdocUpdatedWebhookEventThrottle>    | Custom     |
| storageUpdated webhook event throttle | <Limits.StarterStorageUpdatedWebhookEventThrottle> | <Limits.ProStorageUpdatedWebhookEventThrottle> | Custom     |
