...
| ------------------------------------ | ------------------------------------------------ | -------------------------------------------- | ---------- |
| Monthly active users included        | <Limits.StarterMauIncluded />                    | <Limits.ProMauIncluded />                    | Custom     |
| Monthly active users cap             | <Limits.StarterMauMax />                         | <Limits.ProMauMax />                         | Unlimited  |
