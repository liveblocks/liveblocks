...
| Version history <InfoTooltip>APIs, hooks, and pre-built components to access the previous versions of the realtime data stored in rooms.</InfoTooltip>                                                                                                                                                 | <Limits.FreeVersionHistory />                      | <Limits.ProVersionHistory /> <InfoTooltip><a href="/docs/pricing/plans/team">Upgrade to Team</a> for 90 days</InfoTooltip>                          | <Limits.TeamVersionHistory />                                                                                                                         | <Limits.EnterpriseVersionHistory />                                                                                                                   |
