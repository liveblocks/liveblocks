...
- <Limits.ProMauIncluded /> monthly active users included, then <Limits.ProPAYGPrice /> for
  each additional MAU
...
Storage for Text Editor and Sync Datastore is a cumulative, overall calculation.
It does not reset monthly, and the total usage will continue to accrue over time
as you add more content and data. You can monitor your usage at any time in the
[dashboard](/dashboard).
