...
The Pro plan starts at **$99/month** and is designed for production applications
...
Liveblocks room at least once a month.
...
[authentication](/docs/authentication) docs for more information.
