...
With analytics, you’re able to get insights into the collaborative experiences
for a given project with metrics like daily active users, monthly active users,
connections, active rooms, and more.
