...
You can start installing the updated packages with the following command.
...
### Learn more [#access-tokens-learn-more]
...
[access tokens permissions](/docs/rooms/permissions/access-token) guide.
...
### Learn more [#id-tokens-learn-more]
