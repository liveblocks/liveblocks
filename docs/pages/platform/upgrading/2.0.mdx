...
This will add an empty array to empty `LiveList` constructors:
...
If you have any trouble with these new patterns or otherwise want help, please
let us know [by email](mailto:support@liveblocks.io) or by joining our
