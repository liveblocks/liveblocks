...
meta:
  ...
  description: "Learn how the Liveblocks pricing works"
---
...
application, check out our [Authentication guide](/docs/rooms/authentication).
...
[Liveblocks 1.0 upgrade guide](/docs/platform/upgrading/1.0) for additional
