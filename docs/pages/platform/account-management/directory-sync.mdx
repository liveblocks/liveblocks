...
<Banner>
  Make sure that you are a member of the groups from you directory provider that
  you are synching with Liveblocks Directory Sync, otherwise you might lock
  yourself out.
</Banner>
