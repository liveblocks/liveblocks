...
| ------------------------------------ | --------------------------------------------- | -------------------------------------------- | ---------- |
| Monthly active users included        | <Limits.FreeMauMax />                         | <Limits.ProMauIncluded />                    | Custom     |
...
| Monthly comments limit               | <Limits.FreeMaxCommentsCreatedPerMonth />     | <Limits.FreeMaxCommentsCreatedPerMonth />    | Custom     |
