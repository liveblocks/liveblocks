...
Usage is measured at the team workspace level. For teams on the Pro/Team plan,
you can pay for [additional usage](/docs/platform/limits) as you go.

### Additional usage

For members of our Pro/Team plan, we offer a pay-as-you-go model for additional
