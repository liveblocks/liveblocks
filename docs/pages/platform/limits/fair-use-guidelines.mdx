...
|                             | Free                                         | Pro                                         |
| --------------------------- | -------------------------------------------- | ------------------------------------------- |
| Average monthly connections | Up to <Limits.FreeAvgConnectionsPerMau />    | Up to <Limits.ProAvgConnectionsPerMau />    |
| Monthly active room hours   | Up to <Limits.FreeActiveRoomHoursPerMonth /> | Up to <Limits.ProActiveRoomHoursPerMonth /> |
