...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      [room permissions](/docs/authentication#id-token-room-permissions) can only be set on the back-end through `@liveblocks/node` or our REST API.
      ...
      For more information, make sure to read the section on [room permissions](/docs/authentication#id-token-room-permissions).
