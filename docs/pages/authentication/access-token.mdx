...
If you have already created rooms with IDs that won't work with patterns, you
can follow this
[migrating guide](/docs/guides/migrate-rooms-ids-for-access-token-patterns) to
update your rooms IDs to the right pattern.
