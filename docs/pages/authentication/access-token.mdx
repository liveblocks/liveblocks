...
Let’s picture a tenant in your product, Acme, set up using
[workspace permissions](#workspace-permissions). This customer has a number of
group, and each group contains a number of documents.
