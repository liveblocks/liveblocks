...
If you have already created rooms with IDs incompatible with patterns, you can
use this
[migration guide](/docs/guides/migrate-rooms-ids-for-access-token-patterns) to
update your room IDs to the correct pattern.
