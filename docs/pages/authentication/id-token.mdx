...
Authenticating with ID tokens means creating a JSON Web Token (JWT) that’s used
...
For a full understanding of ID token permissions, it’s recommended to read
