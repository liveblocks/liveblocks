...
The `comments:*` permissions apply to both public and private threads. Use
`comments:public:*` or `comments:private:*` to override one visibility. For
example, you can allow writing public threads while denying access to private
threads.
