...
- **Personal threads** with `comments:personal:read`, `comments:personal:write`,
  or `comments:personal:none`.
- **Feeds** with `feeds:read`, `feeds:write`, or `feeds:none`.

The `comments:*` permissions apply to public, private, and personal threads. Use
`comments:public:*`, `comments:private:*`, or `comments:personal:*` to override
one visibility. For example, you can allow writing public threads while denying
...
[public and private comments](/docs/guides/how-to-use-public-and-private-comments).
...
| `comments:personal:read`  | Personal threads | Read access to personal threads.                       |
| `comments:personal:write` | Personal threads | Write access to personal threads.                      |
| `comments:personal:none`  | Personal threads | No access to personal threads.                         |
