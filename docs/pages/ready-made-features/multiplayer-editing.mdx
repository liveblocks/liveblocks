...
<ListGrid columns={2}>
  <DocsCard
    type="technology"
    title="Tiptap"
    href="/docs/ready-made-features/multiplayer-editing/tiptap"
  ...
  <DocsCard
    type="technology"
    title="BlockNote"
    href="/docs/ready-made-features/multiplayer-editing/blocknote"
  ...
  <DocsCard
    type="technology"
    title="Lexical"
    href="/docs/ready-made-features/multiplayer-editing/lexical"
...
_Use these SDKs to add multiplayer editing to rich text editors._
...
### Multiplayer Editing SDKs

_Use these SDKs to add multiplayer editing to whiteboards, forms, tables, or any
custom UI._
...
<ListGrid columns={2}>
  ...
  <ExampleCard
    example={{
      ...
      image: "/images/examples/thumbnails/tldraw-whiteboard.png",
    }}
    technologies={["nextjs"]}
    openInNewWindow
  />
