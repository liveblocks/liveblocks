...
meta:
  title: "Text editor"
  parentTitle: "Multiplayer Editing"
  description:
...
- **Inline comments and annotations** - Let users highlight text and leave
...
<ListGrid columns={2}>
  <DocsCard
    type="technology"
    title="Tiptap"
    href="/docs/platform/text-editor/liveblocks-tiptap"
  ...
  <DocsCard
    type="technology"
    title="Blocknote"
    href="/docs/platform/text-editor/liveblocks-blocknote"
  ...
  <DocsCard
    type="technology"
    title="Lexical"
    href="/docs/platform/text-editor/liveblocks-lexical"
