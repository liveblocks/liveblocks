...
- **Comments work in read-only mode**: [`FloatingComposer`](/docs/api-reference/liveblocks-react-tiptap#FloatingComposer) and comment threads function normally even when the editor is read-only
- **Toolbars adapt automatically**: The [`FloatingToolbar`](/docs/api-reference/liveblocks-react-tiptap#FloatingToolbar) and [`Toolbar`](/docs/api-reference/liveblocks-react-tiptap#Toolbar) automatically hide editing options when `canWrite` is `false`
