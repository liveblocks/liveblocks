...
A quick overview of the concepts used in Collaboration notifications.

## Inbox Notifications

In Collaboration notifications, everything resolves around _inbox notifications_.
...
`textMention` notifications whe users are mentioned inside the editor.
