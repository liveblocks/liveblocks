...
You can also send notifications on other channels, such as `email`, `slack`, or
`teams`, letting users know when they’ve missed in-app notifications. Using our
dashboard and hooks you can allow users to set their own notification settings.
...
use each differently. Learn more about notification channels in our
