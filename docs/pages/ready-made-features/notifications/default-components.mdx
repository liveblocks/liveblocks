...
Room titles displayed in notifications are obtained using the [`resolveRoomsInfo`](/docs/api-reference/liveblocks-react#LiveblocksProviderResolveRoomsInfo) function in [`LiveblocksProvider`](/docs/api-reference/liveblocks-react#LiveblocksProvider). This allows you to display meaningful document or room names instead of room IDs in your notifications. Learn more in our guide on [how to customize room names in inbox notifications](/guides/how-to-customize-room-names-in-inbox-notifications).
