...
Before starting the migration, it's important to understand the key concepts in Liveblocks Notifications. Review our [notification concepts documentation](/ready-made-features/notifications/concepts) for a comprehensive overview.
...
Inbox notifications are triggered by your backend using the [`triggerInboxNotification` API](/api-reference/liveblocks-node#post-inbox-notifications-trigger).
...
- [Configuring webhooks](/platform/webhooks#Configuring-webhooks)

**Follow this guide to setup email notifications for comments:**

- [Email notifications](/ready-made-features/notifications/email-notifications)

**Follow this guide to setup a new notification kind:**

- [What to check before enabling a new notification kind](/guides/what-to-check-before-enabling-a-new-notification-kind)
...
[InboxNotification component](/ready-made-features/notifications/default-components#InboxNotification)
...
[How to create a notification settings panel](/guides/how-to-create-a-notification-settings-panel#Custom-notification-kinds)
