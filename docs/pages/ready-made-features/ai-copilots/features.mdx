...
{/* - **[One-off prompts](#one-off-prompts)**: Create AI buttons for various tasks, with support for actions, context, more. */}
...
[Actions](#actions) and [context](#knowledge) are supported, allowing AI to
