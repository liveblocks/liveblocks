...
Liveblocks AI Copilots are customizable UI components that let your users
...
{/* - **[One-off prompts](#one-off-prompts)**: Create AI buttons for various tasks, with support for tools, context, more. */}
...
text-based interactions. For example, you may have tools that create new
documents in your app, automatically fill in form data, search the web for data,
or anything else you like.

{/* TODO Better explain tools for non-AI/non-technical readers: action === tool, generative UI ==== tool, etc. */}
...
document or page. You can also submit webpages and files, such as documentation,
that the copilot will deeply internalize, allowing it to reply intelligently.
...
could have a button thgat lets you save it, and add it to a project.
