...
so that is understands the current document or page. You can also submit
webpages and files, such as documentation, that the copilot will deeply
internalize, allowing it to reply intelligently.
