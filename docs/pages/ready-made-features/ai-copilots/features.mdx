...
- **Text editor toolbar**: AI suggestions toolbar for your collaborative text
  editor,.
...
of chats. No database is required, and messages update in realtime using
WebSockets.
...
This toolbar allows to select text, and ask AI to make changes for you, for
...
In future, you will be able to use OAuth to securely authenticate requests to
your back end.
