...
copilot. Setting slightly differ between providers though the “system prompt” is
always the most important setting:
...
## Creating copilots programmatically

You can create copilots programmatically using the
[Liveblocks Node.js client](/docs/api-reference/liveblocks-node).
