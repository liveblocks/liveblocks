...
thread, they’ll receive
[inbox notifications](/docs/ready-made-features/notifications) by default.
...
structure the function differently, [learn more]().
...
There’s two different ways to set up group mentions:

1. By returning a list of group IDs on the front-end.
2. Be creating groups of users on the back-end.
