...
<Banner title="Liveblocks-hosted permissions">

Room permissions are only relevant if you use the Liveblocks-hosted permissions
in your [authentication endpoint](/docs/rooms/authentication).
