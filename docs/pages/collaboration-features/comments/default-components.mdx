...
- Can be used alongside
  [primitives](/docs/collaboration-features/comments/primitives).
...
- [Creating private threads](/docs/api-reference/liveblocks-react-ui#Creating-private-threads)
...
Learn more under
[styling and customization](/docs/collaboration-features/comments/styling-and-customization).
