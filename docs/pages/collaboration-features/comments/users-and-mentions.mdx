...
[inbox notification](/docs/collaboration-features/notifications/concepts#Inbox-Notifications).
...
Similar to when
[displaying user information](/docs/collaboration-features/comments/users-and-mentions#adding-user-information),
