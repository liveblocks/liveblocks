...
[a React hook](/docs/collaboration-features/comments/hooks#threads-hook) or
...
Threads can store
[custom metadata](/docs/collaboration-features/comments/metadata), which is helpful
for integrating them into your product.

## Comments

Each comment is created by a user, referenced by their
[user ID](/docs/collaboration-features/comments/users-and-mentions), and is part of
