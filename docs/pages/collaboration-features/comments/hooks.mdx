...
[default components](/docs/collaboration-features/comments/default-components), or
[primitives](/docs/collaboration-features/comments/primitives). Here’s an example
