...
Styling
[default components](/docs/collaboration-features/comments/default-components) and
[primitives](/docs/collaboration-features/comments/primitives) is enabled through a
range of means, such as CSS variables, class names, and more. It’s also possible
to use
[overrides](/docs/collaboration-features/comments/styling-and-customization#Overrides-and-localization)
...
Primitives
[can be styled like any other element](/docs/collaboration-features/comments/primitives#Use-regular-props)
...
[merge the primitive’s props](/docs/collaboration-features/comments/primitives#Merge-with-your-design-system-components)
