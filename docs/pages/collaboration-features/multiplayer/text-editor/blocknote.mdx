...
[collaborative room](/docs/concepts#Rooms) in your
...
other Liveblocks products such as [Comments](/docs/collaboration-features/comments)
and [Notifications](/docs/collaboration-features/notifications).
