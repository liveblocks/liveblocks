...
features. Each [collaborative room](/docs/concepts#Rooms)
...
Add [Comments](/docs/collaboration-features/comments) to your text editor, allowing
others to select words in the editor, and leave annotations. Each annotation
creates a [thread](/docs/collaboration-features/comments/concepts#Threads), and
...
Add [`useThreads`](/docs/collaboration-features/comments/hooks#threads-hook)
alongside
...
Add a [Notifications](/docs/collaboration-features/notifications) UI to your
...
[sending email notifications](/docs/collaboration-features/notifications/email-notifications).
...
Liveblocks-backed storage instead by passing `collaborationMode:
"liveblocks"`.
...
[Next.js](/docs/get-started/nextjs-tiptap-storage) Storage get started guides, or
read the full
