...
[default components](/docs/collaboration-features/notifications/default-components)
and [hooks](/docs/collaboration-features/notifications/hooks).
...
[Comments](/docs/collaboration-features/comments) can send `thread` notifications
...
[text editors](/docs/collaboration-features/multiplayer) can send
...
[email notifications](/docs/collaboration-features/notifications/email-notifications)
page.
