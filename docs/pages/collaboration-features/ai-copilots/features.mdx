...
[their own set of chats](/docs/collaboration-features/ai-copilots/hooks#List-a-user's-chats).
...
[Tools](/docs/collaboration-features/ai-copilots/tools) are a way to allow AI to
...
[Notifications](/docs/collaboration-features/notifications), and
[Sync Datastore](/docs/collaboration-features/multiplayer/sync-engine). For example, you can allow AI
...
It’s simple to
[add knowledge and context to your AI](/docs/collaboration-features/ai-copilots/knowledge),
...
We also provide [a number of hooks](/docs/collaboration-features/ai-copilots/hooks)
...
Using our
[Text Editor integration for Tiptap](/docs/collaboration-features/multiplayer/text-editor/tiptap),
