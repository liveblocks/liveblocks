...
When writing your
[system prompt](/docs/collaboration-features/ai-copilots/copilots#System-prompt)
...
[JSON schema](/docs/collaboration-features/ai-copilots/tools#Advanced-JSON-schema)
...
[front-end knowledge](/docs/collaboration-features/ai-copilots/knowledge) to create
