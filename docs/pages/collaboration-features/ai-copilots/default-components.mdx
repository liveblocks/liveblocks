...
When
[registering a tool](/docs/collaboration-features/ai-copilots/tools#Registering-a-tool),
the [`AiTool`][] component can be used to
[show tool progress and results](/docs/collaboration-features/ai-copilots/tools)
...
[human-in-the-loop tool action](/docs/collaboration-features/ai-copilots/tools#Default-confirmation-component).
...
Learn more under
[styling and customization](/docs/collaboration-features/ai-copilots/styling-and-customization):
