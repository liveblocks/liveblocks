...
[tools](/docs/collaboration-features/ai-copilots/tools) to create an AI assistant
...
your
[copilot](/docs/collaboration-features/ai-copilots/copilots#Adding-back-end-knowledge).
...
[when AI should use back-end knowledge](/docs/collaboration-features/ai-copilots/copilots#When-should-AI-use-knowledge)
...
After
[creating a copilot](/docs/collaboration-features/ai-copilots/copilots#Creating-a-copilot)
...
`webSearch` option in
[your copilot settings](/docs/collaboration-features/ai-copilots/copilots#Web-search).
...
You can also
[limit the domains that the AI can search](/docs/collaboration-features/ai-copilots/copilots#Limit-web-search-to-specific-domains)
