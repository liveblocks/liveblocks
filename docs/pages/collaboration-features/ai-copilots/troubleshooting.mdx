...
[back-end knowledge](/docs/collaboration-features/ai-copilots/knowledge#Back-end-knowledge)
...
[when AI should use knowledge](/docs/collaboration-features/ai-copilots/copilots#When-should-AI-use-knowledge)
