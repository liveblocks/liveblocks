...
[Multiplayer Editing](/docs/ready-made-features/multiplayer-editing),
...
instead, so that users can receive notifications from other rooms. Data storage
location (e.g. EU, US) is managed at project level and can be selected when
...
[webhooks](/docs/platform/webhooks), [analytics](/docs/platform/analytics), and
more.
