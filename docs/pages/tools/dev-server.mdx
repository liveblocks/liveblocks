...
[Multiplayer](/docs/collaboration-features/multiplayer) features, and partially
supports other APIs. [Learn more](#Partially-supported-features).

| Feature                                                                                                                            | Support |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------- |
| [Liveblocks Storage](/docs/collaboration-features/multiplayer/sync-engine/liveblocks-storage) (LiveObject, Presence, Broadcast, etc.) | ✅      |
| [Liveblocks Yjs](/docs/collaboration-features/multiplayer/sync-engine/liveblocks-yjs)                                                 | ✅      |
| [Text editors](/docs/collaboration-features/multiplayer/text-editor) (Tiptap, BlockNote, Lexical)                                     | ✅ ¹    |
...
| [AI Agents](/docs/collaboration-features/ai-collaboration)                                                                                   | ❌      |
| Other APIs                                                                                                                         | ❌      |
