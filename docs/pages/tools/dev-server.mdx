...
2. Run the specified command (e.g. your unit tests)
...
Server logs: /var/folders/ph/xtwbrg097hsby4l_v3yzqksh0000gn/T/liveblocks-dev-vbV4Da/server.log
...
2. `npx liveblocks dev --cmd "vitest run"` for locally running your unit tests
   against a fresh instance (your local data in `.liveblocks/` is not seen or
   mutated by your unit tests).
