...
The dev server fully supports the listed [Sync](/docs/products/sync) features,
and partially supports other APIs. [Learn more](#Partially-supported-features).

| Feature                                                                                       | Support |
| --------------------------------------------------------------------------------------------- | ------- |
| [Sync](/docs/products/sync) (Storage, presence, Broadcast, etc.)                              | ✅      |
| [Liveblocks Yjs](/docs/products/sync/text-editing/yjs)                                                     | ✅      |
| [Text editors](/docs/use-cases/text-editor) (Tiptap, BlockNote, Lexical)                      | ✅ ¹    |
| [Public key authentication](/docs/api-reference/liveblocks-react#LiveblocksProviderPublicKey) | ✅      |
| [Access token authentication](/docs/api-reference/authentication/access-token)                | ✅      |
| [ID token authentication](/docs/api-reference/authentication#id-token)                        | ✅      |
...
| [AI Agents](/docs/products/ai-copilots)                                                       | ❌      |
| Other APIs                                                                                    | ❌      |
...
ID token authentication will be supported in future.
