...
1.0, check out our [upgrade guides](/docs/api-reference/upgrading).
...
The [Liveblocks Starter Kit](/nextjs-starter-kit) is a great way to get started with
...
will use the
[Advanced Collaborative Spreadsheet](https://liveblocks.io/examples/collaborative-spreadsheet-advanced/nextjs-spreadsheet-advanced).
