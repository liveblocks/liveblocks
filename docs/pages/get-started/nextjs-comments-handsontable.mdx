...
meta:
  title:
    "Get started with commenting in Handsontable using Liveblocks and Next.js"
...
[Handsontable Comments](/examples/handsontable-comments/nextjs-comments-handsontable)
example.
