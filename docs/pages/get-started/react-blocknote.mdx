...
meta:
  title:
    "Get started with a BlockNote text editor using Liveblocks Yjs and React"
  parentTitle: "Quickstart"
  description:
    "Learn how to install a Yjs-backed BlockNote text editor using Liveblocks
    and React"
---
...
[BlockNote get started guide](/docs/get-started/react-blocknote-storage).
...
- [Storage-backed BlockNote React quickstart](/docs/get-started/react-blocknote-storage)
