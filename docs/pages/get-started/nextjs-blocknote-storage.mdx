...
meta:
  title:
    "Get started with a BlockNote text editor using Liveblocks Storage and
    Next.js"
...
experimental offline support), see the
[standard BlockNote Next.js quickstart](/docs/get-started/nextjs-blocknote).
