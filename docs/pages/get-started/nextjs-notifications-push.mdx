---
meta:
  title: "Get started with push notifications using Liveblocks and Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with push notifications using Liveblocks and
    Next.js"
---
    ...
    <StepContent>
      ...
      <Button asChild className="not-markdown">
        <a href="/docs/guides/how-to-notify-users-about-unread-comments-outside-of-your-app">
          How to notify users with push notifications
        </a>
      </Button>
