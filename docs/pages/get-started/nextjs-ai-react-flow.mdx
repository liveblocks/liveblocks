...
<user-message>${prompt}</user-message>`,
  ...
  <Step lastStep>
    ...
    <StepContent>
      ...
      Your AI agent now reads and writes your React Flow diagram in realtime.
...
Congratulations! You’ve set up the foundation for an AI agent that can edit
your collaborative React Flow diagrams.
