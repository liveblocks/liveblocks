...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      Create an [authentication](/docs/api-reference/authentication) endpoint at `/api/liveblocks-auth`,
      passing a unique user ID to [`prepareSession`](/docs/api-reference/liveblocks-node#access-tokens).
