...
[Multiplayer Handsontable](/examples/multiplayer-handsontable/nextjs-multiplayer-handsontable)
example.
...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      reads the grid data from Storage, and
      ...
      export function Table() {
        ...
        // Get the realtime grid contents from Storage
  ...
  <Step lastStep>
    ...
    <StepContent>
      ...
      <Button asChild className="not-markdown">
        <a href="/docs/api-reference/authentication">
