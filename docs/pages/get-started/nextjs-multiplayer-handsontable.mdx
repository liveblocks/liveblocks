...
meta:
  title:
    "Get started with a multiplayer Handsontable spreadsheet using Liveblocks and Next.js"
...
a multiplayer Handsontable spreadsheet for your Next.js application.
