...
[collaboration notifications](/docs/products/notifications/concepts#Collaboration-notifications)
...
<Steps>
  ...
  <Step>
      ...
      <StepContent>
        ...
        app yet, [get started with Comments](/docs/get-started/nextjs-comments)
        before continuing.
...
- [Webhooks API reference](/docs/api-reference/webhook-events)
...
<ListGrid columns={2}>
  <ExampleCard
    example={{
      ...
      slug: "/examples/comments-emails/nextjs-comments-emails-resend",
