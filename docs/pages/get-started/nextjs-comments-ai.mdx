...
replies in [Comments](/docs/products/comments) when mentioned in a thread, using
[`@liveblocks/node`](/docs/api-reference/liveblocks-node), the
...
[AI Comments](/examples/ai-comments/nextjs-comments-ai) example.
...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      [`commentCreated`](/docs/api-reference/webhook-events#CommentCreatedEvent) events,
...
<Step lastStep>
  ...
  <StepContent>
    ...
    [`CommentMetadata`](/docs/api-reference/liveblocks-react#Typing-your-data),
...
- [Comments overview](/docs/products/comments)
