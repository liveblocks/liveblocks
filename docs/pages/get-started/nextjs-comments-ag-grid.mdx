...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      Clicking the buttns opens popovers for creating or viewing comment threads.
  ...
  <Step>
    ...
    <StepContent>
      ...
      Import your `CommentCell` component into `defaultColRef`, and replace the table data with your own.
