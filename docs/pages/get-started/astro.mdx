---
meta:
  title: "Get started with Liveblocks and Astro"
  parentTitle: "Get started"
  description: "Learn how to get started with Liveblocks and Astro"
---

Liveblocks is a real-time collaboration infrastructure for building performant
collaborative experiences. Follow the following steps to start adding
collaboration to your Astro application using the APIs from the
[`@liveblocks/client`](/docs/api-reference/liveblocks-client) package.

<Banner title="Official package">

Liveblocks does not have a package for Astro. If you would like to have one, or
...
<Steps
  ...
  div.innerText = \`There are \${room.getOthers().length} other user(s) online\`;
  \r
...
collaborative experiences for your Astro application.
