...
- [Authentication](/docs/rooms/authentication) - Learn how to authenticate your
  real-time application
- [Managing Rooms](/docs/platform/managing-rooms-users-permissions) - Learn how
  to manage room metadata and permissions
