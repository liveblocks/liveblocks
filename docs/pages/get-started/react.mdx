...
- [Rooms authentication](/docs/rooms/authentication) - Learn how to authenticate
  users into rooms
- [Rooms metadata](/docs/rooms/metadata) - Learn how to set metadata for your
  rooms
- [Rooms permissions](/docs/rooms/metadata) - Learn how to manage permissions
  for your rooms
