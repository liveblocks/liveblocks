...
<Steps
    ...
    },
    {
      ...
      description: (
        <>
          ...
          will be responsible for communicating with our back end. You can do
  ...
  publicApiKey: "{{PUBLIC_KEY}}",
    ...
    },
    {
      ...
      description: `Liveblocks uses the concept of rooms, separate virtual spaces where people can collaborate. To create a real-time experience, multiple users must be connected to the same room.`,
      code: {
        file: "App.tsx",
        language: "ts",
        highlight: "7-11",
