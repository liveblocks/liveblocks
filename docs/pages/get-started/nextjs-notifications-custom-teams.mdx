...
meta:
  title:
    "Get started with Microsoft Teams custom notifications using Liveblocks and
    Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with MicrosoftTeams custom notifications using
    Liveblocks and Next.js"
---

Liveblocks is a realtime collaboration infrastructure for building performant
collaborative experiences. Follow the following steps to start adding Teams
