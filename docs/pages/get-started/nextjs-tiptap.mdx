...
The Tiptap `LiveText` integration is currently in beta. For a Yjs-backed setup,
see the [Tiptap Next.js Yjs quickstart](/docs/get-started/nextjs-tiptap-yjs).
...
- [Yjs-backed Tiptap Next.js quickstart](/docs/get-started/nextjs-tiptap-yjs)
