...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      [tools](/docs/collaboration-features/ai-copilots/tools), [knowledge](/docs/collaboration-features/ai-copilots/knowledge),
      and use [hooks](/docs/collaboration-features/ai-copilots/hooks).
  ...
  <Step lastStep>
    ...
    <StepContent>
      ...
      <Button asChild  className="not-markdown">
        <a href="/docs/collaboration-features/ai-copilots/copilots">
          Create a copilot
        </a>
      </Button>
...
- [Overview of all features and where to start](/docs/collaboration-features/ai-copilots)
