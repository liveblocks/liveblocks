...
See the finished result in the [AI Chats](/examples/ai-chats/nextjs-ai-chats)
example.
...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      Create an [authentication](/docs/api-reference/authentication) API route with [`prepareSession`](/docs/api-reference/liveblocks-node#access-tokens),
  ...
  <Step>
    ...
    <StepContent>
      ...
      [tools](/docs/products/ai-copilots/tools), [knowledge](/docs/products/ai-copilots/knowledge),
      and use [hooks](/docs/products/ai-copilots/hooks).
  ...
  <Step lastStep>
    ...
    <StepContent>
      ...
      <Button asChild  className="not-markdown">
        <a href="/docs/products/ai-copilots/copilots">
          Create a copilot
        </a>
      </Button>
...
- [Overview of all features and where to start](/docs/products/ai-copilots)
...
<ListGrid columns={2}>
  ...
  <ExampleCard
    example={{
      ...
      slug: "ai-support/nextjs-ai-support",
