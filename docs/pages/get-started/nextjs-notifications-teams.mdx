...
meta:
  title:
    "Get started with Microsoft Teams notifications using Liveblocks and Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with Microsoft Teams notifications using
    Liveblocks and Next.js"
---

Liveblocks is a realtime collaboration infrastructure for building performant
collaborative experiences. Follow the following steps to start adding Microsoft
Teams notifications to your Next.js `/app` directory application using methods
