...
The Tiptap LiveText integration is currently in beta, and LiveText documents are
limited to 2 MB. Read the [LiveText vs Yjs](/docs/guides/livetext-vs-yjs) guide
