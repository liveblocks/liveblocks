---
meta:
  title: "Get started with a Tiptap text editor using Liveblocks Yjs and React"
...
[Tiptap get started guide](/docs/get-started/react-tiptap-storage).
...
<Steps>
  ...
  <Step>
    ...
    Follow the
    [Storage-backed Tiptap React quickstart](/docs/get-started/react-tiptap-storage)
