...
meta:
  title:
    "Get started with Web Push custom notifications using Liveblocks and Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with Web Push custom notifications using
    Liveblocks and Next.js"
---

Liveblocks is a realtime collaboration infrastructure for building performant
collaborative experiences. Follow the following steps to start adding Web Push
