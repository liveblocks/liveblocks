...
meta:
  title:
    "Get started with commenting in an HTML table using Liveblocks and Next.js"
...
<Steps>
  ...
  <Step lastStep>
    ...
    <StepContent>
      ...
      Comments is set up and working now inside your table, but each user is anonymous—the next step is to
