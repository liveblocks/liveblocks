...
meta:
  title:
    "Get started with Push custom notifications using Liveblocks and Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with Push custom notifications using Liveblocks
    and Next.js"
---

Liveblocks is a realtime collaboration infrastructure for building performant
collaborative experiences. Follow the following steps to start adding Push
custom notifications to your Next.js `/app` directory application using methods
...
Congratulations! You've set up Push notifications in your Next.js application.
