...
meta:
  title:
    "Get started with a BlockNote text editor using Liveblocks Yjs and Next.js"
  parentTitle: "Quickstart"
  description:
    "Learn how to get started with a Yjs-backed BlockNote text editor using
...
[BlockNote get started guide](/docs/get-started/nextjs-blocknote-storage).
...
[Collaborative Text Editor](/examples/collaborative-text-editor/nextjs-blocknote)
example.
...
BlockNote text editor inside your Next.js application.

- [@liveblocks/react-blocknote API Reference](/docs/api-reference/liveblocks-react-blocknote)
- [Storage-backed BlockNote Next.js quickstart](/docs/get-started/nextjs-blocknote-storage)
