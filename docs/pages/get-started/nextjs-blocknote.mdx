...
This BlockNote `LiveText` integration is currently in beta. For a Yjs-backed
setup, see the
[BlockNote Next.js Yjs quickstart](/docs/get-started/nextjs-blocknote-yjs).
...
- [Yjs-backed BlockNote Next.js quickstart](/docs/get-started/nextjs-blocknote-yjs)
