...
Create a new vue app by running the following command and selecting Typescript as an option:

```bash
npx @vue/cli create liveblocks-app
```
...
[`createClient`][] inside one of your Vue components.
...
Liveblocks should now be installed in your project!
