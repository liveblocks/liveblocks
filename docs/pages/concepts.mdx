...
Liveblocks is a realtime infrastructure for multiplayer apps. It’s built on a
small set of foundational concepts list below. These concepts work together to
let people and AI collaborate inside your app, without changing your existing
...
| Products      | Sync, Feeds, Comments, Notifications, and AI Copilots                                                      |
...
notification inbox. Each project can have multiple organizations, though only
one is required.

## Rooms

A room is a stateful WebSocket server on the edge. It represents the space where
people and AI agents collaborate together. Inside a room, you can enable things
like presence, shared state for multiplayer interactions, contextual comment
threads, @ mentions and actions that trigger notifications.

<Figure>
  <Image
    src="/assets/concepts/liveblocks-rooms.png"
    alt="Liveblocks rooms. The space where people and AI agents collaborate."
    width={1536}
    height={880}
    quality={100}
  />
...
Liveblocks products provide pre-built components, hooks, and APIs that handle
the complexity of realtime collaboration, allowing you to focus on building your
...
<ListGrid columns={2}>
  <DocsCard
    ...
    description="Synchronize persistent collaborative state"
    visual={<DocsStorageIcon className="fill-product-icon-brand h-auto w-6" />}
  />
  <DocsCard
    type="technology"
    title="Feeds"
    href="/docs/products/feeds"
    description="Create realtime message streams"
    visual={
  ...
  <DocsCard
    ...
    description="Add contextual discussions"
  ...
  <DocsCard
    ...
    description="Deliver collaboration activity"
...
- Fully compatible with the
  [`<AiChat />`](/docs/products/ai-copilots/default-components#AiChat)
  component.
