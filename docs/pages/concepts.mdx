...
<ListGrid columns={2}>
  <DocsCardFeature
    feature="presence"
    href="/realtime-infrastructure?primitive=presence"
  />
  <DocsCardFeature
    feature="broadcast"
    href="/realtime-infrastructure?primitive=broadcast"
  />
  <DocsCardFeature
    feature="storage"
    href="/realtime-infrastructure?primitive=storage"
  />
  <DocsCardFeature
    feature="feeds"
    href="/realtime-infrastructure?primitive=feeds"
  />
  <DocsCardFeature
    feature="threads"
    href="/realtime-infrastructure?primitive=threads"
  />
</ListGrid>
