...
- **Ready-made features** — collaboration building blocks like Comments,
  Multiplayer, Notifications, and AI Agents
- **Platform** — the realtime backend, admin dashboard, and SDKs that make
  collaboration possible at scale
...
A project is the top-level container in your Liveblocks account.
...
[insert something about tenants]
