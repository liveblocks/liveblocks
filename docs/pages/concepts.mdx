...
| Products      | Sync, Comments, and Notifications                                                                          |
...
<ListGrid columns={2}>
  ...
  />
  <DocsCardFeature feature="feeds" href="/docs/products/sync/feeds" />
  <DocsCardFeature
    feature="threads"
...
[DevTools browser extension](/docs/tools/devtools) and a comprehensive set of
SDKs and packages.
