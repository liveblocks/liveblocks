...
[Tiptap](/docs/collaboration-features/multiplayer/text-editor/tiptap),
[Lexical](/docs/collaboration-features/multiplayer/text-editor/lexical),
[BlockNote](/docs/collaboration-features/multiplayer/text-editor/blocknote),
...
doesn’t actually delete the document’s history—it adds a new “delete everything”
