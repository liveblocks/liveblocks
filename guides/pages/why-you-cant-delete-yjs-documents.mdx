...
This guide applies to our extensions for [Tiptap](/docs/use-cases/text-editor),
[Lexical](/docs/use-cases/text-editor),
[BlockNote](/docs/use-cases/text-editor), as they all use Yjs under the hood.
