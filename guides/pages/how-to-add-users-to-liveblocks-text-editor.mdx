...
meta:
  ...
  description:
    "Learn how to add your user’s avatars and names to Liveblocks Text Editor using
    the resolver functions."
---

After following the get started guide for Text Editor, you’ll notice that each user
is currently “Anonymous”, and that there’s no way to mention or tag other users.
To enable these features, we need to tell Text Editor where to find your users’
information.
...
user, the color of their cursor, and their avatar URL, as these properties will both be used
in the [Text editor](/docs/products/text-editor). Here’s an
...
users to mention inline, for example after typing the `@` character. We can create a
...
You’re now ready to start building your Text Editor application! Here’s where you
can learn more:
...
- [Overview](/docs/products/text-editor)
