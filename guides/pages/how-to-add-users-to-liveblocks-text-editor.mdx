...
and authenticate your app, as this is necessary for Text Editor.
...
both be used in the [Text editor](/docs/use-cases/text-editor). Here’s an
...
- [Overview](/docs/use-cases/text-editor)
