---
meta:
  title: "How to modify Storage from the server"
  description:
    "Learn about the different methods you can use to modify Storage within
    Node.js"
---

In realtime applications, Storage is generally modified from the browser with
[`useMutation`](/docs/api-reference/liveblocks-react#useMutation) or through
