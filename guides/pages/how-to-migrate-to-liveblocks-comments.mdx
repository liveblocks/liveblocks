...
[set up authentication](https://liveblocks.io/docs/api-reference/authentication)
in your app, deciding on either _ID tokens_ or _access tokens_.
...
[access tokens](/docs/api-reference/authentication/access-token#permissions) or
[ID tokens](/docs/api-reference/authentication#id-token-room-permissions) to
fully understand setting up your room.
...
understand the [concepts behind Comments](/docs/products/comments/concepts).
When a thread is created, the first comment is also created, and you can do this
with
