...
understand the
[concepts behind Comments](/docs/collaboration-features/comments/concepts). When a
...
Liveblocks stores
[is each user’s ID](/docs/collaboration-features/comments/users-and-mentions).
