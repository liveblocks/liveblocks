---
meta:
  title: "How to use Storage with Redux"
  description: "Learn how to use Storage with Redux"
---

In this guide, we’ll be learning how to use Storage with Redux using the APIs
from the [`@liveblocks/redux`][] package.
