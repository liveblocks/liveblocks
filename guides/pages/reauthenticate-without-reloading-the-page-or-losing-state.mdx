...
Sometimes it’s helpful to [reauthenticate](/docs/api-reference/authentication)
users, for example after a logged out user has signed into your application, and
you wish to display their details.
