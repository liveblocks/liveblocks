...
- Trigger events when comments are created using the
  [CommentCreated](/docs/api-reference/webhook-events#CommentCreatedEvent) webhook event.
...
along with some
[other information](/docs/api-reference/webhook-events#CommentCreatedEvent).
...
[`getComment`](/docs/api-reference/liveblocks-node#get-rooms-roomId-threads-threadId-comments-commentId) and
...
- How to use the `@liveblocks/node` package to get
  [comment data](/docs/api-reference/liveblocks-node#get-rooms-roomId-threads-threadId-comments-commentId) and
  [thread participants](/docs/api-reference/liveblocks-node).
