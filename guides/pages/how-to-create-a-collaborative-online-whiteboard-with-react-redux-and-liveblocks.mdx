...
- [React tutorial](/docs/get-started/multiplayer/canvases)
- [React + Zustand tutorial](/docs/guides/how-to-create-a-collaborative-online-whiteboard-with-react-zustand-and-liveblocks)
...
[`storageMapping: { shapes: true }`](/docs/api-reference/liveblocks-redux#enhancer-option-storage-mapping).
...
[`presenceMapping: { selectedShape: true }`](/docs/api-reference/liveblocks-redux#enhancer-option-presence-mapping)
