...
using React and Liveblocks. As users add and move rectangles in a canvas,
...
[in our examples](/examples/collaborative-whiteboard/nextjs-whiteboard).
...
key. For more info, see the [authentication guide](/docs/rooms/authentication).
...
<Figure>
  <video autoPlay loop muted playsInline>
    <source
      src="/assets/tutorials/whiteboard/tutorial-whiteboard-7.mp4"
      type="video/mp4"
    />
  </video>
</Figure>
