...
[`createClient`](/docs/api-reference/liveblocks-client#createClient) in our
config file, learning how to:
...
<Steps>
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="5-11" file="liveblocks.config.ts"
      // ...
  ...
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="10-19" file="liveblocks.config.ts"
      // ...
  ...
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="6-11" file="liveblocks.config.ts"
      // ...
...
<Steps>
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="8-15" file="liveblocks.config.ts"
      // ...
  ...
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="9-19" file="liveblocks.config.ts"
      // ...
