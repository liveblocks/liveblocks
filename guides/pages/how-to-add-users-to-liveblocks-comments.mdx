...
[`createRoomContext`](/docs/api-reference/liveblocks-react#createRoomContext) in
...
in the [default components](/docs/products/comments#Components). Here’s an
example using access token authentication, with an email address as a user’s ID.
...
<Steps>
  ...
  <Step>
    ...
    <StepContent>
      ...
      ```ts highlight="8-13" file="liveblocks.config.ts"
      // ...
