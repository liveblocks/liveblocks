...
If you’re using our [Text Editor](/docs/use-cases/text-editor) BlockNote
integration, there’s an
...
[Storage](/docs/products/sync/storage) and [Yjs](/docs/products/sync/text-editing/yjs).
