...
meta:
  ...
  description:
    "Learn how use Liveblocks and SWR to revalidate API data in real-time"
---
...
your data in real-time by broadcasting events using Liveblocks.
...
To create a function that allows us to update this data in real-time, we can
...
Great, data that revalidates in real-time at the click of a button! You can find
