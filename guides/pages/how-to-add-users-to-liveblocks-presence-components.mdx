...
[authentication guide for your framework](/docs/api-reference/authentication)
and authenticate your app, as this is necessary for adding users. Here’s an
example using ID token authentication, our recommended method, with an email
