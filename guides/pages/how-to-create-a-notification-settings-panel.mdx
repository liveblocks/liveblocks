...
notifications on other channels, such as email, Slack, Microsoft Teams. This
guide shows you how to create a notification preferences panel, allowing users
to choose where to receive each notification.
