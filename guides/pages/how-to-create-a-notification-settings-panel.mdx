...
[Notifications](/docs/products/notifications) allows you to add in-app
notifications to your product. However, it also allows you to send unread
...
You can also use
[custom notification kinds](/docs/products/notifications/concepts#Custom-notifications)
