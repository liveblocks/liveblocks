...
[Notifications](/docs/collaboration-features/notifications) allows you to add
...
You can also use
[custom notification kinds](/docs/collaboration-features/notifications/concepts#Custom-notifications)
