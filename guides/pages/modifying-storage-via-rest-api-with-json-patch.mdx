...
[LiveText](/docs/api-reference/liveblocks-client#LiveText) nodes. When building
your patch:
...
- **LiveText values:** Patch LiveText using its Plain LSON shape:
  `{ "liveblocksType": "LiveText", "data": LiveTextData }`. You can patch
  fields under `data`, for example `/text/data/0/0`. LiveText versioning is an
  internal detail and is not part of this API.
