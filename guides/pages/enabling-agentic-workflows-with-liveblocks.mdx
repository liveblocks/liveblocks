...
<Figure>
  <Image
    src="/assets/agentic/agentic-workflows.png"
    alt="Liveblocks agentic workflows"
    width={1344}
    height={660}
  />
</Figure>
...
- **JSON Patch** (`PATCH /v2/rooms/{roomId}/storage/json-patch`): Lets an agent
  modify [Storage](/docs/products/sync/storage) using the RFC 6902 standard,
  which is well understood by LLMs, making it straightforward for AI models to
  generate patch operations directly from natural language instructions.
...
POST https://api.liveblocks.io/v2/rooms/{roomId}/realtime-infrastructure?primitive=presence
```
...
<Figure>
  <Image
    src="/assets/agentic/avatar-stack-with-ai.png"
    alt="Avatar stack with AI agent"
    width={1344}
    height={640}
  />
</Figure>
...
<Figure>
  <Image
    src="/assets/agentic/input-presence-ai.png"
    alt="AI agent input presence"
    width={1344}
    height={640}
  />
</Figure>
...
def set_presence(focused_field: str, status: str, ttl: int = 30):
    requests.post(
        f"{BASE}/rooms/{ROOM}/realtime-infrastructure?primitive=presence",
        json={
            "userId": AGENT_ID,
...
<Figure>
  <Image
    src="/assets/agentic/mention-ai.png"
    alt="AI agent mentioned in a comment"
    width={1344}
    height={640}
  />
</Figure>
...
[`commentCreated`](/docs/api-reference/webhook-events#CommentCreatedEvent) webhook fires
...
- [Users and mentions](/docs/products/comments/users-and-mentions): Setting up
