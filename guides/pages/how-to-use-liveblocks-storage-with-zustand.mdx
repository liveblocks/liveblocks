---
meta:
  title: "How to use Storage with Zustand"
  description: "Learn how to use Storage with Zustand"
---

In this guide, we’ll be learning how to use Storage with Zustand using the APIs
from the [`@liveblocks/zustand`][] package.
