...
Notifications are a core driver of engagement in collaborative products. They
bring users back into the experience, sustain collaboration loops, and connect
key workflows like comments, spaces, and AI copilots so work moves forward
naturally.

By moving to Liveblocks Notifications, you can unify how updates are delivered
across your product suite, ensuring that users receive timely, relevant, and
actionable updates instead of noisy alerts. This creates cross-product
consistency, deeper engagement, and long-term retention, making collaboration a
...
migrated and validated, you can switch fully to Liveblocks Notifications to
power your end-to-end collaboration experience.
...
There are two main ways to use notifications in Liveblocks, depending on what
your product needs.

**Liveblocks notifications** are built in and designed to cover the most common
collaboration patterns out of the box. They automatically handle things like
mentions, replies, and comment activity across your app. For example, when
someone tags a teammate or replies in a thread, a Liveblocks notification is
...
Together, they let you balance speed and control. Use Liveblocks notifications
to power your core collaboration flows and add custom ones wherever your product
needs a more tailored experience.
...
- The **project notification settings** refer to how channel notifications can
  ...
  <Figure>
    <Image
      src="/assets/notifications/project-notification-settings-kinds.jpg"
  ...
  <Figure>
    <Image
      src="/assets/notifications/project-notification-settings-edit.jpg"
...
- The **user notification settings** refer to how a user can choose which
  notifications to receive on which channel.
...
<Figure>
  <Image
    src="/assets/notifications/notification-flow.jpg"
...
In this architecture, your applications communicate directly with Liveblocks to
trigger notifications. This is the simplest approach and works well for most use
cases.

### Applications send notifications to a notification service

In this architecture, your applications send notifications to a centralized
notification service, which then forwards them to Liveblocks. This approach is
useful if you need to maintain a central notification hub or perform additional
processing before sending notifications to Liveblocks.
