...
[`YDocUpdated`](/docs/api-reference/webhook-events#YDocUpdatedEvent) webhook event. This
...
- [YDocUpdated webhook event](/docs/api-reference/webhook-events#YDocUpdatedEvent)
