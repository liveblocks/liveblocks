...
changes occur. Duplicating/reading data may be useful for creating full-text
search, making backups, analytics, and more.
...
- **New user onboarding**: Loading the current document state when someone
  joins.
