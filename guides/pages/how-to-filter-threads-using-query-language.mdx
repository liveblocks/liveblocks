...
[custom metadata](/docs/collaboration-features/comments/metadata) and our custom
...
You can filter threads by their metadata, resolved status, or visibility,
allowing you to select for certain properties, values, or even for string
prefixes. Filters can be combined using `AND` logic.
...
[read our guide](/docs/collaboration-features/comments/metadata).
