...
unread comments, and use them to trigger notifications in Slack, Microsoft
Teams, or any other external service with an API, using webhooks. Notifications
can also be displayed in your app using
...
[get started with Comments](/docs/get-started/nextjs-comments), and come back after
you’re set up.
...
[thread notification](/docs/api-reference/webhook-events#Thread-notification), as we’re
...
and [`getThread`](/docs/api-reference/liveblocks-node#get-rooms-roomId-threads-threadId).
