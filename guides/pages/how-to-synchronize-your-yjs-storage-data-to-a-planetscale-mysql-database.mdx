...
meta:
  title:
    "How to synchronize your Yjs Storage data to a PlanetScale MySQL database"
  description:
...
To use webhooks, you need to add your endpoint URL to the webhooks dashboard
...
To check if it worked, go back to the Console page on PlanetScale and enter the
following to see all entries:
...
date, within the throttle limit.
