...
notifications with [Comments](/docs/collaboration-features/comments) or
[Text editor](/docs/collaboration-features/multiplayer/text-editor), you’ll notice that each
...
in the [default components](/docs/collaboration-features/notifications#Components).
