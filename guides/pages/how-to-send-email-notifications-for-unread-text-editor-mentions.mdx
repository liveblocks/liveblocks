...
[Text Editor](/docs/collaboration-features/multiplayer/text-editor) using Tiptap or Lexical.
...
[overview page](/docs/collaboration-features/multiplayer/text-editor/lexical#Notifications).
