...
[Text Editor](/docs/use-cases/text-editor) using Tiptap or Lexical. Using our
webhooks and REST API, it’s possible get unread text mentions and use them to
email users when they’re mentioned in a document. Notifications can also be
...
[Lexical](/docs/get-started/multiplayer/text-documents) or
[Tiptap](/docs/get-started/multiplayer/text-documents), and come back after you’re set
up. You could also use our
[ready-made email examples](/examples/collaborative-text-editor-emails/nextjs-tiptap-emails-resend) which
...
[overview page](/docs/use-cases/text-editor#Mentions-and-notifications).
...
[text mention notification](/docs/api-reference/webhook-events#TextMention-notification),
