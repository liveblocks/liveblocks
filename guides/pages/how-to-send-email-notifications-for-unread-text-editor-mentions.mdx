...
[Text Editor](/docs/ready-made-features/text-editor). Using our webhooks and
REST API, it’s possible get unread text mentions and use them to email users
when they’re mentioned in a document. Notifications can also be displayed in
your app using
