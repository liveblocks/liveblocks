...
possible get unread text mentions and use them to email users when they’re
...
[Lexical](/docs/api-reference/liveblocks-react-lexical) text editor, though the
...
[get started with Lexical](/docs/get-started/text-editor/lexical), and come back
