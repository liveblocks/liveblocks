...
Liveblocks [Notifications](/docs/products/notifications) allows you to build a
notification inbox, and send custom notifications to your users. With our
webhooks and REST API, it’s possible to fetch unread
[custom notifications](/docs/products/notifications/concepts#Custom-notifications)
...
- Trigger events based on unread custom notifications using the
  [`NotificationEvent`](/docs/api-reference/webhook-events#NotificationEvent) webhook
  event.
...
[get started with Notifications](/docs/get-started/nextjs-notifications-in-app), and come back
after you’re set up.
...
[concepts page](/docs/products/notifications/concepts).
...
provide is the [`NotificationEvent`](/docs/api-reference/webhook-events#NotificationEvent)
...
[notification kind](/docs/products/notifications/concepts#Notification-kinds) on
the Slack channel. You must always enable the correct channel to ensure your
[`NotificationEvent`](/docs/api-reference/webhook-events#NotificationEvent) webhook events
...
[custom notification](/docs/api-reference/webhook-events#Custom-notification) with the
...
- How to use [webhooks](/docs/platform/webhooks) and the
  [`NotificationEvent`](/docs/api-reference/webhook-events#NotificationEvent).
- How to use the [`@liveblocks/node`](/docs/api-reference/liveblocks-node)
  package to fetch the custom notification data.
