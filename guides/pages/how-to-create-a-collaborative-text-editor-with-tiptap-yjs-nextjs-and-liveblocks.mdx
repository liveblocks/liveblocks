...
<Banner title="Not recommended" type="warning">
  This is a guide on setting up your editor with [Sync Datastore +
  Yjs](/sync-datastore/yjs). We instead recommend using [Text
  Editor](/text-editor) our first-party Tiptap plugin, as it provides many
  built-in features for you. [Get started
  here](/docs/get-started/nextjs-tiptap).
</Banner>
