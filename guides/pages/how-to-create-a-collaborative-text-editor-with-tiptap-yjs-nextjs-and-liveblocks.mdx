...
[Tiptap Yjs getting started guide](/docs/get-started/nextjs-tiptap-yjs).
However, should you like to set up Tiptap manually with Yjs, without using our
full feature set, continue reading.
...
features, such as [presence](/docs/products/sync/presence). The
