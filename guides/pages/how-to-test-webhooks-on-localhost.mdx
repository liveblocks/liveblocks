...
The URL is generates can be placed into the Liveblocks webhooks dashboard for
quick testing.
...
It’s recommend to verify that your webhook requests have come from Liveblocks,
...
Make sure to add your “Liveblocks webhook Secret” from the Liveblocks
...
Visit the [webhook event](/docs/platform/webhooks#Liveblocks-events) section of
