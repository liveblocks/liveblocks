...
and required no code changes**. Both the
[Storage data model](/docs/products/sync/storage) and
[Yjs documents](/docs/products/sync/text-editing/yjs) in Sync run on top of the v2 engine.
