...
meta:
  ...
  description: "Learn about our improved storage engine v2 and how to enable it"
---

Since v3.14, rooms can be powered by our new storage engine v2. Switching is
...
1. Click Settings
2. Toggle "Use Engine v2 for new rooms"
