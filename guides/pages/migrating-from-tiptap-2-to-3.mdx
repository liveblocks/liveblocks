...
future version conflicts as we upgrade. _Note:_ This includes any extra TipTap
extensions you may have installed or anything else with a dependency on TipTap.

```bash
npm uninstall @tiptap/react @tiptap/starter-kit @liveblocks/client @liveblocks/react @liveblocks/react-ui @liveblocks/react-tiptap
```
