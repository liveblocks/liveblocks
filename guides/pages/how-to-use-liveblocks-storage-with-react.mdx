---
meta:
  title: "How to use Storage with React"
  description: "Learn how to use Storage with React"
---

In this guide, we’ll be learning how to use Storage with React using the hooks
from the [`@liveblocks/react`][] package.
...
With Storage, it’s possible to nest data structures inside each other, for
example `scientist` could hold a [`LiveList`][] containing a list of pets.
