...
import type { FlowchartFeedMessageData } from "@/liveblocks.config";
...
function isFlowchartFeedMessageData(
  data: Liveblocks["FeedMessageData"]
): data is FlowchartFeedMessageData {
  return "stage" in data;
}
        ...
        <>
          ...
          {commentProps.comment.metadata.feedComplete ? (
            <CommentPrimitive.Body
              ...
              components={{
                Mention: ({ mention }) => (
                  <span className="flowchart-ai-comment-mention">
                    @
            ...
            <div className="flowchart-ai-comment-markdown">
...
function AiComment({
  ...
  if (!messages || !lastMessage || !isFlowchartFeedMessageData(lastMessage.data)) {
    return (
      <StreamingComment
        commentProps={commentProps}
        title="Running..."
