...
export const BLOCK_SHAPES = [
  ...
  "ellipse",
  "diamond",
] as const satisfies readonly BlockShape[];
...
export const BLOCK_COLORS = {
  ...
  purple: "#85f",
  gray: "#678",
} as const satisfies Record<BlockColor, string>;
...
export const BLOCK_HANDLE_SIDES = [
  "top",
  "right",
  "bottom",
  "left",
...
export type { BlockColor, BlockShape, FlowchartEdge, FlowchartNode };
...
export function isBlockShape(value: string | undefined): value is BlockShape {
  return value
    ? BLOCK_SHAPES.some((shape: string) => shape === value)
    : false;
}
