...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description:
      "See collaborators' live cursors as you work together on the same diagram.",
  },
  {
    icon: <CommentIcon />,
...
export function HelpControl() {
  ...
  return (
    <>
      <ControlButton
        className="flowchart-help-control"
...
function HelpDialog({
  ...
  return createPortal(
    <div
      className="flowchart-help-backdrop"
    ...
    >
      <div
        className="flowchart-help"
        style={styles.panel}
        onClick={(event) => event.stopPropagation()}
      >
        <div style={styles.header}>
          <div>
            <h2 id="flowchart-help-title" style={styles.title}>
              Collaborative flowchart
            </h2>
            <p style={styles.desc}>How to use this document</p>
          </div>
          <button
            type="button"
            className="flowchart-help-close"
            style={styles.close}
            aria-label="Close"
            onClick={onClose}
          >
