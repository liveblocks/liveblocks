...
const EMPTY_BODY = `
  <section class="card">
    ...
    <p>It will generate initial designs for you, and you can take it from there. Or dive into the code if you would prefer.</p>
  </section>
`;

const createBody = (slideContent: string) => `<!doctype html>
<html>
  <head>
    <meta charset="utf-8" />
...
export const STARTER_SLIDE_HTML = createBody(STARTER_BODY);
export const EMPTY_SLIDE_HTML = createBody(EMPTY_BODY);
