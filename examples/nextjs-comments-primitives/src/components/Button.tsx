...
function buttonClassNames(variant: ButtonProps["variant"]) {
  return [
    "flex h-9 items-center rounded-md px-4 text-sm font-semibold outline-none ring-offset-2 focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50",
    {
