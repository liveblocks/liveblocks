...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Messages live in a Liveblocks feed and sync instantly to everyone connected to the room.",
  },
  {
    icon: <UsersIcon />,
    title: "Shared across users",
    description:
      "Open this example in two tabs — every message and AI reply appears for both at once.",
  },
  {
    icon: <ZapIcon />,
    title: "Replies from the server",
    description:
      "The AI answer is generated server-side and written into the feed with @liveblocks/node.",
  },
  {
    icon: <CommentIcon />,
    title: "Built with AI Elements",
    description: (
      <>
        The UI uses Vercel{" "}
        <a
