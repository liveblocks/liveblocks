...
This example shows how to build a collaborative text editor with [Liveblocks](https://liveblocks.io), [Yjs](https://docs.yjs.dev), [Lexical]([https://tiptap.dev](https://lexical.dev/)), and [Next.js](https://nextjs.org/).
