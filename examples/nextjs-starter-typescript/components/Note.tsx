...
function Note ({ shape, dragged, onPointerDown, onDelete, onChange, onFocus, onBlur }: NoteProps) {
  ...
  // Update useState shape's props whenever they change
  const room = useRoom();
  useEffect(() => {
    ...
    <>
      <div
        ...
        style={{
          ...
          transition: !dragged ? "transform 120ms linear" : undefined,
          zIndex: dragged ? 1 : 0,
        }}
        ...
        <div className={styles.noteInner} style={{ borderColor: selectedBy?.color || undefined }}>
          ...
          <div className={styles.noteBody}>
            ...
            <textarea
              ...
              style={{ fontSize, borderColor: selectedBy?.color ? "rgba(0, 0, 0, 0.08)" : undefined }}
