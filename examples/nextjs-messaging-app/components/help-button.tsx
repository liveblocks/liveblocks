...
const EXAMPLE_NAME = "Messaging App";
const EXAMPLE_URL =
  "https://liveblocks.io/examples/messaging-app/nextjs-messaging-app";
...
const FEATURES: Feature[] = [
  {
    icon: <HashIcon />,
    title: "Channels stored in Liveblocks",
    description:
      "Create, rename, delete, and drag channels to reorder them — the list lives in Storage and syncs live.",
  },
  {
    icon: <SparklesIcon />,
    title: "AI teammate",
    description:
      "@mention Liveblocks AI in a message and watch its reply stream into the channel.",
  },
  {
    icon: <UsersIcon />,
    title: "Shared across users",
    description:
      "Open this example in two tabs and pick different users from the dropdown to see messages, typing indicators, and presence sync.",
  },
  {
    icon: <PenIcon />,
    title: "Rich text and mentions",
    description:
      "Write with markdown shortcuts like *bold* and `code`, and @mention teammates.",
  },
];
