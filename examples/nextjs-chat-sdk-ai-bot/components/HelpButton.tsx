...
const EXAMPLE_NAME = "AI bot (Chat SDK + Liveblocks Comments)";
...
const EXAMPLE_URL = "https://liveblocks.io/docs/examples/liveblocks-chat-sdk";
...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Start threads and reply to others using Liveblocks Comments inside a shared room.",
  },
  {
    icon: <AtIcon />,
    title: "Mention the AI bot",
    description:
      "@-mention the bot in any comment to ask it a question within the thread.",
  },
  {
    icon: <SparklesIcon />,
    title: "Streaming AI replies",
    description:
      "The bot answers with responses streamed live from Claude into the thread.",
  },
  {
    icon: <UsersIcon />,
