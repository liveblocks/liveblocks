...
export function buildChatReplySystemPrompt({
  ...
  return [
    [
      ...
      "Requests for changes are normally routed to the coding agent before they reach you, so treat what you get as a question. If a request to change something does reach you anyway, answer whatever can be answered in words and add one sentence saying the change itself hasn't been made and can be requested again; don't ask clarifying questions on the coding agent's behalf.",
