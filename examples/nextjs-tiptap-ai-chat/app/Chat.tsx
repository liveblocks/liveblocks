...
const STARTER_PROMPTS = [
  ...
  "Add a Risks section with three risks",
  "Make the intro paragraph more punchy",
  "Summarize this document in the chat",
];
  ...
  return (
    <>
            ...
            <ConversationEmptyState>
              ...
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Ask the AI to rewrite, extend, or clean up the shared
                  document. Its edits are applied live for everyone — and every
              ...
              return (
                <Message from={role} key={message.id}>
                  <MessageContent>
                    ...
                    {isAssistant && edits && edits.length > 0 ? (
                      <div className="flex flex-col gap-2">
                        ...
                        {revertVersionId && !streaming ? (
                          <RevertEditButton versionId={revertVersionId} />
                        ) : null}
                      </div>
                    ) : null}
      ...
      <div className="flex flex-col gap-3 p-4">
        ...
        >
          <PromptInputBody>
            <PromptInputTextarea placeholder="Ask the AI to edit the document…" />
          </PromptInputBody>
          <PromptInputFooter>
            <PromptInputTools>
...
/**
 * Restores the document to the version snapshot taken right before this
 * reply's first edit. The restore is applied through Storage like any other
 * change, so it syncs live to everyone (and is itself undoable).
 */
function RevertEditButton({ versionId }: { versionId: string }) {
  ...
  return (
    ...
    >
      ...
      Revert document to before this edit
    </Button>
  );
}
