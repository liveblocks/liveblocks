...
function App({ roomId }: { roomId: string }) {
  ...
  return (
    <div className="flex h-dvh w-full justify-center overflow-hidden bg-neutral-50 p-2.5">
      <div className="flex w-full max-w-[1100px] max-h-[900px] h-full my-auto gap-2.5">
        ...
        <main className="flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg bg-white shadow ring-1 ring-neutral-950/5">
          <header className="flex items-center justify-between gap-2 border-b border-neutral-950/5 px-3 py-2">
          ...
          <div
            className={historyOpen ? "hidden" : "flex min-h-0 flex-1 flex-col"}
          >
            <DocumentEditor />
          </div>
          {historyOpen ? (
