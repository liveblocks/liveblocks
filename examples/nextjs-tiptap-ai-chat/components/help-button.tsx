...
const EXAMPLE_NAME = "Tiptap editor with an AI chat";
const EXAMPLE_URL =
  "https://liveblocks.io/examples/tiptap-ai-chat/nextjs-tiptap-ai-chat";
...
const FEATURES: Feature[] = [
  {
    icon: <SparklesIcon />,
    title: "AI that edits the document",
    description:
      "Ask the AI in the chat to rewrite, extend, or clean up the shared Tiptap document. Edits are applied on the server with mutateStorage and merge with what you're typing.",
  },
  {
    icon: <UsersIcon />,
    title: "Multiplayer everything",
    description:
      "Open this example in two tabs — the document, cursors, comments, and every chat message sync live for both.",
  },
  {
    icon: <ZapIcon />,
    title: "Version history",
    description:
      "A version is saved automatically before every AI edit. Browse versions from the clock icon, or revert an edit straight from the chat.",
  },
  {
    icon: <CommentIcon />,
    title: "Comments in the editor",
    description:
      "Select some text and use the floating toolbar to start a comment thread, anchored to the document.",
  },
];
