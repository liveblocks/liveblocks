  ...
  return (
    <div>
      {status === "synchronizing" ? (
        <SvgSpinners180RingWithBg className="w-5 h-5 opacity-60 p-[1px]" />
      ) : (
        // <IcOutlineCloudUpload className="w-5 h-5" />
        <MaterialSymbolsCheckCircle className="w-5 h-5 opacity-60" />
      )}
    </div>
  );
}
...
export function IcOutlineCloudUpload(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function IcOutlineCloudDone(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
