...
# Multiplayer Diffs Editor

<p>
  <a href="https://liveblocks.io/examples/collaborative-text-editor/nextjs-diffs-editor/preview">
...
This example shows how to build a multiplayer code editor with
[Liveblocks](https://liveblocks.io) [LiveText](https://liveblocks.io/docs/api-reference/liveblocks-client#LiveText),
[Diffs edit mode](https://diffs.com/docs#edit-mode), live carets, and
[Next.js](https://nextjs.org/), without using Yjs.
...
- Add `LIVEBLOCKS_SECRET_KEY="sk_localdev"` and
  `NEXT_PUBLIC_LIVEBLOCKS_BASE_URL="http://localhost:1153"` to `.env.local`
- Run `npm run dev` and go to [http://localhost:3000](http://localhost:3000)
