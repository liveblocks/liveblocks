...
const EXAMPLE_NAME = "Multiplayer Diffs Editor";

const EXAMPLE_URL =
  "https://github.com/liveblocks/liveblocks/tree/main/examples/nextjs-diffs-editor";
...
const FEATURES: Feature[] = [
  {
    icon: <CodeIcon />,
    title: "Diffs edit mode",
    description:
      "The code surface is rendered by Diffs and made editable with its experimental edit mode.",
  },
  {
    icon: <TypeIcon />,
    title: "LiveText storage",
    description:
      "Every local edit is converted to a LiveText operation, so collaborators converge without Yjs.",
  },
  {
    icon: <MergeIcon />,
    title: "Multiplayer editing",
    description:
      "Open the example in two tabs and edit the same file to see code changes sync in real time.",
  },
  {
    icon: <BoldIcon />,
    title: "Live carets",
    description:
      "Selections are shared through Liveblocks Presence and rendered as remote caret labels.",
  },
];
