...
<p>
  ...
  <a href="https://codesandbox.io/s/github/liveblocks/liveblocks/tree/main/examples/nextjs-redux-whiteboard">
...
```bash
npx create-liveblocks-app@latest --example nextjs-redux-whiteboard --no-api-key --no-vercel
```
...
After forking [this example](https://codesandbox.io/s/github/liveblocks/liveblocks/tree/main/examples/nextjs-redux-whiteboard) on CodeSandbox, create the `NEXT_PUBLIC_LIVEBLOCKS_PUBLIC_KEY` environment variable as a [public](https://codesandbox.io/docs/secrets).
