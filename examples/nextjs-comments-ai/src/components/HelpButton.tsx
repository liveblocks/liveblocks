...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Start a thread with the composer and reply to keep conversations in context.",
  },
  {
    icon: <UsersIcon />,
    title: "Mentions",
    description:
      "Type @ to mention a teammate or tag the AI agent inside any comment.",
  },
  {
    icon: <SparklesIcon />,
    title: "AI replies",
    description:
      "Tag the AI agent to get a helpful answer streamed straight into the thread.",
  },
  {
    icon: <LightbulbIcon />,
    title: "Live reasoning",
    description:
      "Watch the AI think and write in real time, then expand to read its reasoning.",
  },
  {
    icon: <EyeIcon />,
    title: "Presence avatars",
    description:
      "See who is currently in the room, with the AI appearing while it responds.",
  },
];
