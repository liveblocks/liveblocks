        ...
        {activity.map((activityItem, activityItemindex) => (
          <li key={activityItem.id} className="relative flex gap-x-4">
            ...
            activityItem.type === "added" ? (
              <>
                <div className="relative flex size-6 flex-none items-center justify-center bg-white dark:bg-neutral-950">
                  <div className="size-1.5 rounded-full bg-neutral-100 ring-1 ring-neutral-300 dark:bg-neutral-950 dark:ring-neutral-700" />
                </div>
                <p className="flex-auto py-0.5 text-xs leading-5 text-neutral-500 dark:text-neutral-500">
                ...
                <time
                  ...
                  className="flex-none py-0.5 text-xs leading-5 text-neutral-500 dark:text-neutral-500"
                >
                  {activityItem.date}
                </time>
              </>
              ...
              <>
                ...
                />
                <div className="flex-auto rounded-md p-3 ring-1 ring-neutral-300 ring-inset dark:ring-neutral-800">
                  <div className="flex justify-between gap-x-4">
                    <div className="py-0.5 text-xs leading-5 text-neutral-500 dark:text-neutral-500">
                      <span className="font-medium text-neutral-900 dark:text-neutral-50">
                        {activityItem.person.name}
                      </span>{" "}
                      commented
