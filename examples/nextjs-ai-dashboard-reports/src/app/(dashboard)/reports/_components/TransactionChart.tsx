...
function getLatestTransactionDate(transactions: Transaction[]): Date {
...
export function TransactionChart({
  ...
  const chartData = useMemo(() => {
    // Use the latest transaction date as the current date
    const currentDate = getLatestTransactionDate(transactions)
