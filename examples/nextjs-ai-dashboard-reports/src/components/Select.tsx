...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger flex w-full items-center justify-between gap-2 truncate rounded-md border px-3 py-2 text-base shadow-xs outline-hidden transition select-none sm:text-sm",
    // border color
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            // disabled
            "group-data-disabled/trigger:text-neutral-300 dark:group-data-disabled/trigger:text-neutral-600",
          )}
        />
