...
const EXAMPLE_NAME = "AI Slideshow";
const EXAMPLE_URL =
  "https://liveblocks.io/examples/ai-slideshow/nextjs-ai-slideshow";
...
const FEATURES: Feature[] = [
  {
    icon: <SparklesIcon />,
    title: "AI slide proposals",
    description:
      "Ask the assistant for a slide, then apply or reject its complete HTML proposal.",
  },
  {
    icon: <UsersIcon />,
