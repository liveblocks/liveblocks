...
const EXAMPLE_NAME = "Tiptap AI HTML Blocks";

const EXAMPLE_URL =
  "https://liveblocks.io/examples/tiptap-ai-html/nextjs-tiptap-ai-html";
...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Edit a Tiptap document together, with every change synced through Liveblocks in real time.",
  },
  {
    icon: <SlashIcon />,
    title: "Slash commands",
    description:
      'Type "/" to insert headings, lists, quotes, code blocks, dividers, and AI blocks.',
  },
  {
    icon: <SparklesIcon />,
    title: "AI HTML blocks",
    description:
      'Pick "HTML component" from the slash menu, describe an idea, and AI generates an interactive HTML block.',
  },
  {
    icon: <CodeBoxIcon />,
    title: "Sandboxed interactive previews",
    description:
      "Generated HTML runs in a sandboxed iframe and syncs to everyone in the room.",
  },
  {
    icon: <UsersIcon />,
    title: "Live avatars",
    description:
      "See who else is in the document through live collaborator avatars.",
  },
];
