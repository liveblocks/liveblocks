...
const EXAMPLE_NAME = "Tiptap AI HTML Editor";
...
const FEATURES: Feature[] = [
  {
    icon: <EditIcon />,
    title: "Collaborative Tiptap editor",
    description:
      "Write together in a rich-text document with every change synced and persisted by Liveblocks.",
  },
  {
    icon: <SlashIcon />,
    title: "Slash commands",
    description:
      "Type / to insert headings, code blocks, quotes, or the AI HTML component.",
  },
  {
    icon: <SparklesIcon />,
  ...
  },
  {
    ...
    description:
      "Select text to add contextual comments and discuss changes with other collaborators.",
  },
];
