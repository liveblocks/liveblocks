...
This example shows how to build display comments overlaid on any website with [Liveblocks](https://liveblocks.io) and [Next.js](https://nextjs.org/).
...
After forking [this example](https://codesandbox.io/s/github/liveblocks/liveblocks/tree/main/examples/nextjs-comments-website-overlay) on CodeSandbox, create the `LIVEBLOCKS_SECRET_KEY` environment variable as a [secret](https://codesandbox.io/docs/secrets).
