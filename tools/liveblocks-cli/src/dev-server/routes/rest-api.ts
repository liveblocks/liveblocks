...
// prettier-ignore
{
  ...
  zen.route("PUT /v2/rooms/<roomId>/attachments/<attachmentId>/upload/<name>", () => NOT_IMPLEMENTED());
  zen.route("POST /v2/rooms/<roomId>/attachments/<attachmentId>/multipart/<name>", () => NOT_IMPLEMENTED());
  zen.route("PUT /v2/rooms/<roomId>/attachments/<attachmentId>/multipart/<uploadId>/<partNumber>", () => NOT_IMPLEMENTED());
