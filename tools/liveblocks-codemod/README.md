...
[upgrade guide](https://liveblocks.io/docs/api-reference/upgrading/2.0) to learn more
about the changes.
...
See the [upgrade guide](https://liveblocks.io/docs/api-reference/upgrading/3.0) to
