...
- [Online avatars](/examples/live-avatar-stack/nextjs-live-avatars)
- [Selection or location indicators](/examples/live-form-selection/nextjs-live-form-selection)
- [“User currently typing...” messages](/examples/collaborative-todo-list/nextjs-todo-list)
