...
- Created new guide on
  [adding users to Collaboration notifications](https://liveblocks.io/docs/guides/how-to-add-users-to-liveblocks-notifications).
- Created new guide on
...
- We redesigned our website to represent the Liveblocks product offering more
  ...
  - New page product page for
    [Collaboration notifications](https://liveblocks.io/notifications)
  - New page product page for
