...
sr -s '(  +|\bServerMsgCode[.])Event\b' -r '${1}BROADCASTED_EVENT'
...
sr -s '(  +|\bClientMsgCode[.])ClientEvent\b' -r '${1}BROADCAST_EVENT'
...
sr -s '(  +|\bCrdtType[.])Object\b([^.])' -r '${1}OBJECT${2}'
sr -s '(  +|\bCrdtType[.])List\b([^.])' -r '${1}LIST${2}'
sr -s '(  +|\bCrdtType[.])Map\b([^.])' -r '${1}MAP${2}'
sr -s '(  +|\bCrdtType[.])Register\b([^.])' -r '${1}REGISTER${2}'
...
sr -s '\bEventMessage\b' -r 'BroadcastedEventServerMsg'
...
sr -s '\bClientEventMessage\b' -r 'BroadcastEventClientMsg'
